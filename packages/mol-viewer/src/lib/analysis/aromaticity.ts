...
function bondsOf(bonds: readonly Bond[], atomId: string): Bond[] {
  return bonds.filter(bond => bond.atomId1 === atomId || bond.atomId2 === atomId)
}

function degree(bonds: readonly Bond[], atomId: string): number {
