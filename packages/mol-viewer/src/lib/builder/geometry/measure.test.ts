...
describe('calcDistance', () => {
  it('两点距离：勾股定理', () => {
    ...
    expect(calcDistance(a, b)).toBeCloseTo(5, 5)
  })

  it('同一点距离为 0', () => {
    const a = newAtom('C', 1, 2, 3)
    expect(calcDistance(a, a)).toBeCloseTo(0, 5)
  })
})
...
describe('calcAngle', () => {
  it('直线排列：键角 180°', () => {
    ...
    expect(calcAngle(a, b, c)).toBeCloseTo(180, ANGLE_TOL)
  })
  ...
  it('直角：键角 90°', () => {
    ...
    expect(calcAngle(a, b, c)).toBeCloseTo(90, ANGLE_TOL)
  })
  ...
  it('水分子 H-O-H 键角约 104.5°', () => {
    ...
    expect(calcAngle(h1, o, h2)).toBeCloseTo(104.5, 1)
  })
})

describe('calcDihedral', () => {
  it('共面（二面角 0°）', () => {
    const a = newAtom('C', 0, 1, 0)
    const b = newAtom('C', 0, 0, 0)
    const c = newAtom('C', 1, 0, 0)
    const d = newAtom('C', 1, 1, 0)
    expect(Math.abs(calcDihedral(a, b, c, d))).toBeCloseTo(0, ANGLE_TOL)
  })
  ...
  it('90° 二面角', () => {
    ...
    expect(Math.abs(calcDihedral(a, b, c, d))).toBeCloseTo(90, ANGLE_TOL)
  })
})
