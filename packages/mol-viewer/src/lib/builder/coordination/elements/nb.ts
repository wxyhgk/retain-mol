...
const NB_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const NB_COORDINATION_SET = defineTransitionMetalCoordinationSet('Nb', NB_COORDINATION_SPECS)
