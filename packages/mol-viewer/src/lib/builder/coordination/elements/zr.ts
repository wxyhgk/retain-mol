...
const ZR_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const ZR_COORDINATION_SET = defineTransitionMetalCoordinationSet('Zr', ZR_COORDINATION_SPECS)
