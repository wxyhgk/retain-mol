...
const BH_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const BH_COORDINATION_SET = defineTransitionMetalCoordinationSet('Bh', BH_COORDINATION_SPECS)
