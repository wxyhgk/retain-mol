...
const RH_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const RH_COORDINATION_SET = defineTransitionMetalCoordinationSet('Rh', RH_COORDINATION_SPECS)
