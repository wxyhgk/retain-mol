...
const Y_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const Y_COORDINATION_SET = defineTransitionMetalCoordinationSet('Y', Y_COORDINATION_SPECS)
