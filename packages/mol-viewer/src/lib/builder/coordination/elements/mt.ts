...
const MT_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const MT_COORDINATION_SET = defineTransitionMetalCoordinationSet('Mt', MT_COORDINATION_SPECS)
