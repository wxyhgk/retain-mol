...
const PT_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const PT_COORDINATION_SET = defineTransitionMetalCoordinationSet('Pt', PT_COORDINATION_SPECS)
