...
const DB_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const DB_COORDINATION_SET = defineTransitionMetalCoordinationSet('Db', DB_COORDINATION_SPECS)
