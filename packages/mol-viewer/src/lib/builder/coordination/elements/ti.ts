...
const TI_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const TI_COORDINATION_SET = defineTransitionMetalCoordinationSet('Ti', TI_COORDINATION_SPECS)
