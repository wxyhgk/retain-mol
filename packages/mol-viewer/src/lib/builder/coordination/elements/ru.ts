...
const RU_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const RU_COORDINATION_SET = defineTransitionMetalCoordinationSet('Ru', RU_COORDINATION_SPECS)
