...
const ZN_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const ZN_COORDINATION_SET = defineTransitionMetalCoordinationSet('Zn', ZN_COORDINATION_SPECS)
