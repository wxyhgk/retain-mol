...
const TA_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const TA_COORDINATION_SET = defineTransitionMetalCoordinationSet('Ta', TA_COORDINATION_SPECS)
