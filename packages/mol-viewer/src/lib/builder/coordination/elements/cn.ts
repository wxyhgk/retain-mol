...
const CN_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const CN_COORDINATION_SET = defineTransitionMetalCoordinationSet('Cn', CN_COORDINATION_SPECS)
