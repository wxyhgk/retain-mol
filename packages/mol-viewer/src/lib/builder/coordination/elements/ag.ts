...
const AG_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const AG_COORDINATION_SET = defineTransitionMetalCoordinationSet('Ag', AG_COORDINATION_SPECS)
