...
const CD_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const CD_COORDINATION_SET = defineTransitionMetalCoordinationSet('Cd', CD_COORDINATION_SPECS)
