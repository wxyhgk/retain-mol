...
const MN_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const MN_COORDINATION_SET = defineTransitionMetalCoordinationSet('Mn', MN_COORDINATION_SPECS)
