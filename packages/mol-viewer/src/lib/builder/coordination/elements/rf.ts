...
const RF_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const RF_COORDINATION_SET = defineTransitionMetalCoordinationSet('Rf', RF_COORDINATION_SPECS)
