...
const CU_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const CU_COORDINATION_SET = defineTransitionMetalCoordinationSet('Cu', CU_COORDINATION_SPECS)
