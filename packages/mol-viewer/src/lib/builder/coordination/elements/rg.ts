...
const RG_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const RG_COORDINATION_SET = defineTransitionMetalCoordinationSet('Rg', RG_COORDINATION_SPECS)
