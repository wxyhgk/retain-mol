...
const DS_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const DS_COORDINATION_SET = defineTransitionMetalCoordinationSet('Ds', DS_COORDINATION_SPECS)
