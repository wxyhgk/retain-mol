...
const HG_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const HG_COORDINATION_SET = defineTransitionMetalCoordinationSet('Hg', HG_COORDINATION_SPECS)
