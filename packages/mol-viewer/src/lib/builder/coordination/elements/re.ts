...
const RE_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const RE_COORDINATION_SET = defineTransitionMetalCoordinationSet('Re', RE_COORDINATION_SPECS)
