...
const SC_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const SC_COORDINATION_SET = defineTransitionMetalCoordinationSet('Sc', SC_COORDINATION_SPECS)
