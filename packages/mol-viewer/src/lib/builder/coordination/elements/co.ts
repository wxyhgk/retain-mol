...
const CO_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const CO_COORDINATION_SET = defineTransitionMetalCoordinationSet('Co', CO_COORDINATION_SPECS)
