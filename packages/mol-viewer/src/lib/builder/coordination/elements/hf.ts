...
const HF_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const HF_COORDINATION_SET = defineTransitionMetalCoordinationSet('Hf', HF_COORDINATION_SPECS)
