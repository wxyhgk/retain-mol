...
const MO_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const MO_COORDINATION_SET = defineTransitionMetalCoordinationSet('Mo', MO_COORDINATION_SPECS)
