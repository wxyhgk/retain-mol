...
const NI_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const NI_COORDINATION_SET = defineTransitionMetalCoordinationSet('Ni', NI_COORDINATION_SPECS)
