...
const V_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const V_COORDINATION_SET = defineTransitionMetalCoordinationSet('V', V_COORDINATION_SPECS)
