...
const CR_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const CR_COORDINATION_SET = defineTransitionMetalCoordinationSet('Cr', CR_COORDINATION_SPECS)
