...
const TC_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const TC_COORDINATION_SET = defineTransitionMetalCoordinationSet('Tc', TC_COORDINATION_SPECS)
