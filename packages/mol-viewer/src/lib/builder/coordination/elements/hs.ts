...
const HS_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const HS_COORDINATION_SET = defineTransitionMetalCoordinationSet('Hs', HS_COORDINATION_SPECS)
