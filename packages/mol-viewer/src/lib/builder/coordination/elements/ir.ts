...
const IR_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const IR_COORDINATION_SET = defineTransitionMetalCoordinationSet('Ir', IR_COORDINATION_SPECS)
