...
const OS_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const OS_COORDINATION_SET = defineTransitionMetalCoordinationSet('Os', OS_COORDINATION_SPECS)
