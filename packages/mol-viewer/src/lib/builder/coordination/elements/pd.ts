...
const PD_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const PD_COORDINATION_SET = defineTransitionMetalCoordinationSet('Pd', PD_COORDINATION_SPECS)
