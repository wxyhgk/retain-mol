...
const AU_COORDINATION_SPECS: readonly TransitionMetalCoordinationSpec[] = [
  { geometryId: 'linear' },
...
export const AU_COORDINATION_SET = defineTransitionMetalCoordinationSet('Au', AU_COORDINATION_SPECS)
