// Generated by build.mjs from subscription/index.js. DO NOT EDIT.
const __mod = { exports: {} };
...
export default __ns;
export const { Subscription, PipelineSubscription, StoppableSubscription, DOMSubscription } = __ns;
