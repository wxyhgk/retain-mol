...
import { exec } from '../primitives/cliparea/cliparea';
...
import type { ActionEditorContext, Tools, UiAction } from './action.types';

export * from './action.types';

const disableIfViewOnly = (editor: ActionEditorContext): boolean =>
  ...
  clear: {
    ...
    action: {
      thunk: (dispatch, getState) => {
        ...
        if (!editor.struct().isBlank()) editor.clear();
      },
    },
...
function hasSelection(editor: ActionEditorContext) {
