...
import SchemaInput from '../SchemaInput/SchemaInput';
...
import { MeasurementUnits } from 'src/ui/data/schema/options-schema';
...
const MeasureInput = ({
  ...
  // SchemaInput binds onChange once in its constructor, so handleChange is stuck with
