...
type RGroupDialogResult = RGroupAttributes & { label: number };

type RGroupFragmentToolContext = Omit<
  Pick<
    IToolContext,
...
class RGroupFragmentTool implements Tool {
  private readonly editor: RGroupFragmentToolContext;
