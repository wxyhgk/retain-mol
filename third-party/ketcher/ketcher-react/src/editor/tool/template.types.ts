...
export type TemplateTransactionContext = Pick<
  IToolContext,
  'event' | 'findMerge' | 'render' | 'update'
>;

export type TemplatePreviewContext = TemplateTransactionContext &
  Pick<IToolContext, 'findItem' | 'struct'>;

export type TemplateToolContext = TemplatePreviewContext &
  Pick<IToolContext, 'hover' | 'selection'>;

export type TemplateAttachmentContext = TemplateTransactionContext &
  Pick<IToolContext, 'errorHandler' | 'notifyDocumentChange'>;
