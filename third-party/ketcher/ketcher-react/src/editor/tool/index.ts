...
export const toolsMap: Record<string, ToolConstructorInterface> = {
  hand: HandTool as unknown as ToolConstructorInterface,
  rgroupatom: RGroupAtomTool as unknown as ToolConstructorInterface,
  select: SelectCommonTool,
  fragmentSelection: FragmentSelectionTool,
  sgroup: SGroupTool as unknown as ToolConstructorInterface,
  atom: AtomTool as unknown as ToolConstructorInterface,
  ...
  chain: ChainTool as unknown as ToolConstructorInterface,
  // Cast to ToolConstructorInterface: constructor param types are narrower
  // than `unknown[]`, but toolsMap only ever calls these with the correct args.
  template: TemplateTool as unknown as ToolConstructorInterface,
  charge: ChargeTool as unknown as ToolConstructorInterface,
  rgroupfragment: RGroupFragmentTool as unknown as ToolConstructorInterface,
  apoint: APointTool as unknown as ToolConstructorInterface,
  attach: AttachTool as unknown as ToolConstructorInterface,
  // Cast to ToolConstructorInterface: constructor param types are narrower
  // than `unknown[]`, but toolsMap only ever calls these with the correct args.
  ...
  paste: PasteTool as unknown as ToolConstructorInterface,
  // Cast to ToolConstructorInterface: constructor param types are narrower
  // than `unknown[]`, but toolsMap only ever calls these with the correct args.
  ...
  text: TextTool as unknown as ToolConstructorInterface,
  [IMAGE_KEY]: ImageTool as unknown as ToolConstructorInterface,
