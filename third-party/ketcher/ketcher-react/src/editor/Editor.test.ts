import { Bond, type Render, type Struct } from 'ketcher-core';
import Editor from './Editor';
import { MonomerWizardManager } from './core/MonomerWizardManager';
...
const getTerminalRGroupAtoms = (editor: Editor) => {
  return editor.monomerWizardManager.terminalRGroupAtoms;
};
