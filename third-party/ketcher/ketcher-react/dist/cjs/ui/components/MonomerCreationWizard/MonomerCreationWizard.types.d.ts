import type { KetMonomerClass, AttachmentPointName } from 'ketcher-core';
...
export type WizardFormFieldId = 'type' | 'symbol' | 'name' | 'naturalAnalogue' | 'aliasHELM' | 'aliasBILN';
export type RnaPresetWizardStateFieldId = 'base' | 'sugar' | 'phosphate' | 'preset';
export type RnaPresetWizardComponentStateFieldId = Exclude<RnaPresetWizardStateFieldId, 'preset'>;
...
export type WizardErrors = Partial<Record<WizardFormFieldId | 'emptyModificationType', boolean>>;
...
export type RnaPresetWizardAction = (WizardAction & {
...
export type AssignedAttachmentPointsByMonomerType = Map<WizardState, Map<AttachmentPointName, [number, number]>>;
