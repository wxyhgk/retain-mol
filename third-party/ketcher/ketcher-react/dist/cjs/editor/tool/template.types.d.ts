 ...
 ***************************************************************************/
import type { Action, ItemsToFuse, Struct, Vec2 } from 'ketcher-core';
import type { ClosestItemWithMap } from '../shared/closest.types';
import type { IToolContext } from './IToolContext';
export type TemplateTransactionContext = Pick<IToolContext, 'event' | 'findMerge' | 'render' | 'update'>;
export type TemplatePreviewContext = TemplateTransactionContext & Pick<IToolContext, 'findItem' | 'struct'>;
export type TemplateToolContext = TemplatePreviewContext & Pick<IToolContext, 'hover' | 'selection'>;
export type TemplateAttachmentContext = TemplateTransactionContext & Pick<IToolContext, 'errorHandler' | 'notifyDocumentChange'>;
 ...
 */
export type MergeItems = ItemsToFuse | null;
/**
