...
export type ArrowAddTool = Required<Pick<Tool, 'mousemove' | 'mouseup' | 'mousedown'>>;
export type ReactionArrowClosestItem = ClosestItemWithMap<Vec2, 'rxnArrows'>;
export type MultitailArrowClosestItem = ClosestItemWithMap<MultitailArrowReferencePosition, typeof MULTITAIL_ARROW_KEY>;
