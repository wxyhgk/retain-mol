...
export type ContextMenuProps = BondsContextMenuProps | AtomContextMenuProps | SelectionContextMenuProps | FunctionalGroupsContextMenuProps | RGroupAttachmentPointContextMenuProps | MultitailArrowContextMenuProps | MacromoleculeContextMenuProps | AttachmentPointLabelContextMenuProps;
export interface MenuItemsProps<T extends ContextMenuProps> {
    triggerEvent?: TriggerEvent;
    propsFromTrigger?: T;
}
export type ItemEventParams<T extends ContextMenuProps = ContextMenuProps> = PredicateParams<T, unknown>;
