import type { Action, EditMonomerVariant, EditorDocumentChangeReason, MonomerCreationInitialValues, MonomerCreationState, Render, RenderOptions, SGroupAttachmentPoint, Struct } from 'ketcher-core';
...
export interface IToolContext {
    ...
    selection(selection?: Selection | 'all' | 'descriptors' | null): Selection | null;
