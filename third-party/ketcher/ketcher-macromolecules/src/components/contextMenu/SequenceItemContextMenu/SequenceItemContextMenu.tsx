...
import { Icon, type MacromoleculesIconName } from 'src/uiBridge';
...
export const SequenceItemContextMenu = ({
  ...
  const menuItems = [
    ...
    },
    {
      ...
      title: 'Copy',
      icon: <Icon name={'copyMenu' as MacromoleculesIconName} />,
      disabled: selectedMonomers?.length === 0,
    },
    {
      name: SequenceItemContextMenuNames.paste,
      title: 'Paste',
      icon: <Icon name={'pasteNavBar' as MacromoleculesIconName} />,
    ...
    },
    {
      ...
      title: 'Delete',
      disabled: selectedMonomers?.length === 0,
      icon: <Icon name={'deleteMenu' as MacromoleculesIconName} />,
    },
  ];
