import { AmbiguousMonomerType, AttachmentPointsToBonds, IKetIdtAliases, MonomerItemType, PolymerBond, PresetPosition, RnaPhosphatePosition } from 'ketcher-core';
...
export type EditorStatePreview = MonomerPreviewState | PresetPreviewState | BondPreviewState | AmbiguousMonomerPreviewState | TextPreviewState;
