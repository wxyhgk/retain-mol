import { validateCancelRequest, validateCommitRequest, validateEditRequest, } from 'molecule-contracts';
...
export function createMoleculeCanvasEditor(source, options = {}) {
    if (!source ||
    ...
    function commitEdit(input) {
        ...
        try {
            ...
            const built = buildCanvasCandidate(live, pending.base, pending.prepared.candidate, identities);
            if (!built.ok)
                return freeze(built);
