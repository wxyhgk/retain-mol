...
exports.createCanvasReaderController = createCanvasReaderController;
exports.createMoleculeCanvasReader = createMoleculeCanvasReader;
...
function createCanvasReaderController(source, options = {}) {
    ...
    const identityCheck = (0, molecule_contracts_1.validateDocumentSnapshot)({
    ...
    function setState(status, reason, issues = []) {
        state = freeze({
            schema: molecule_contracts_1.CANVAS_SCHEMA,
            documentId,
            revision,
            status,
            reason,
    ...
    function capture(reason) {
        ...
        try {
            ...
            const projected = (0, projection_js_1.projectStructure)(struct, {
                documentId,
                revision,
...
function createMoleculeCanvasReader(source, options = {}) {
