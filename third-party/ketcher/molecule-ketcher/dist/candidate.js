import { Atom, Bond, Fragment, Highlight, Struct, Vec2, } from 'ketcher-core';
...
export function buildCanvasCandidate(source, base, candidate, identities) {
    try {
        ...
        for (const component of struct.findConnectedComponents(true)) {
            ...
            const fragment = new Fragment([], [...component].every((id) => source.atoms.get(id)?.pp.x === struct.atoms.get(id).pp.x &&
