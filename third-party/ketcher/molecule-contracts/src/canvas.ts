...
export const CANVAS_SCHEMA = 'retainmol.molecule-canvas.v1';
...
export type MoleculeCanvasChangeReason =
  | 'initial'
  | 'edit'
  | 'undo'
  | 'redo'
...
export interface MoleculeCanvasApi extends MoleculeCanvasReader {
  ...
  cancelEdit(request: unknown): Result<{ readonly preparedId: string }>;
}
