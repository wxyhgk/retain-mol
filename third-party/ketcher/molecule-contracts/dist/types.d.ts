export declare const EDIT_SCHEMA = "retainmol.molecule-edit.v1";
export declare const DOCUMENT_SCHEMA = "retainmol.molecule-document.v1";
export declare const PROFILE = "basic-graph-v1";
...
export type MoleculeCommand = ({
    ...
    ref: string;
    element: string;
} & Partial<Omit<AtomProperties, 'element'>>) | {
    op: 'atom.update';
...
export type ErrorCode = 'invalid-request' | 'invalid-structure' | 'document-mismatch' | 'revision-conflict' | 'request-id-conflict' | 'reference-not-found' | 'duplicate-reference' | 'self-bond' | 'duplicate-bond' | 'atom-has-bonds' | 'no-change' | 'prepared-not-found' | 'history-conflict' | 'history-empty' | 'unsupported-runtime' | 'unsupported-document' | 'canvas-unavailable' | 'editing-unavailable' | 'canvas-busy' | 'canvas-changed' | 'canvas-commit-failed' | 'canvas-rollback-failed' | 'missing-coordinates' | 'reader-disposed' | 'limit-exceeded';
