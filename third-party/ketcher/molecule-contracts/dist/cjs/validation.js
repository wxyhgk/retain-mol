...
exports.validateDocumentSnapshot = validateDocumentSnapshot;
exports.validateCommitRequest = validateCommitRequest;
exports.validateCancelRequest = validateCancelRequest;
exports.validateHistoryRequest = validateHistoryRequest;
...
function validate(input, schema) {
    ...
    try {
        ...
        if (schema === schemas_js_1.moleculeEditRequestSchema &&
...
function validateEditRequest(input) {
    return validate(input, schemas_js_1.moleculeEditRequestSchema);
}
function validateDocumentSnapshot(input) {
    return validate(input, schemas_js_1.moleculeDocumentSchema);
}
function validateCommitRequest(input) {
    return validate(input, schemas_js_1.moleculeCommitRequestSchema);
}
function validateCancelRequest(input) {
    return validate(input, schemas_js_1.moleculeCommitRequestSchema);
}
function validateHistoryRequest(input) {
    return validate(input, schemas_js_1.moleculeHistoryRequestSchema);
}
