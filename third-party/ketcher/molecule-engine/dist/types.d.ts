import type { EditReceipt, HistoryReceipt, MoleculeCommand, MoleculeDocumentSnapshot, PreparedEdit, Result } from 'molecule-contracts';
...
export interface MoleculeSession {
    ...
    cancelEdit(input: unknown): Result<{
