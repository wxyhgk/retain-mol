...
var functionalGroupsProvider = require('../helpers/functionalGroupsProvider.js');
...
var FunctionalGroup = function () {
  ...
  _createClass__default["default"](FunctionalGroup, [{
    ...
    key: "isExpanded",
    get: function get() {
      return Boolean(_classPrivateFieldGet__default["default"](this, _sgroup).data.expanded);
    }
  }, {
    key: "relatedSGroup",
    get: function get() {
    ...
    value: function isFunctionalGroup(sgroup) {
      var provider = functionalGroupsProvider.FunctionalGroupsProvider.getInstance();
    ...
    value: function isAtomInContractedFunctionalGroup(atom, sgroups, functionalGroups) {
      return _toConsumableArray__default["default"](atom.sgs.values()).some(function (sgid) {
    ...
    value: function isHalfBondInContractedFunctionalGroup(halfBond, struct) {
      ...
      assert.assert(bond != null);
      return this.isBondInContractedFunctionalGroup(bond, struct.sgroups, struct.functionalGroups);
    }
  }, {
    key: "isContractedFunctionalGroup",
    value: function isContractedFunctionalGroup(sgroup$1, functionalGroups) {
      var isFunctionalGroup = false;
      var expanded = false;
      if (sgroup$1 instanceof sgroup.SGroup) {
        if (sgroup$1.functionalGroup) {
          isFunctionalGroup = true;
          expanded = sgroup$1.functionalGroup.isExpanded;
        }
      } else {
        functionalGroups.forEach(function (fg) {
          if (fg.relatedSGroupId === sgroup$1) {
            isFunctionalGroup = true;
...
//# sourceMappingURL=functionalGroup.js.map
