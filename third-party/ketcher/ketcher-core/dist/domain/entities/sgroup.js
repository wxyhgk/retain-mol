...
require('../helpers/functionalGroupsProvider.js');
var saltsAndSolventsProvider = require('../helpers/saltsAndSolventsProvider.js');
require('../constants/generics.js');
require('../helpers/attachmentPointCalculations.js');
var vec2 = require('./vec2.js');
var constants = require('../../application/editor/shared/constants.js');
...
var SGroupBracketParams = _createClass__default["default"](function SGroupBracketParams(c, d, w, h) {
  ...
  _defineProperty__default["default"](this, "c", void 0);
  _defineProperty__default["default"](this, "d", void 0);
  _defineProperty__default["default"](this, "n", void 0);
  _defineProperty__default["default"](this, "w", void 0);
  _defineProperty__default["default"](this, "h", void 0);
  this.c = c;
  this.d = d;
...
var SGroup = function () {
  function SGroup(type) {
    ...
    _defineProperty__default["default"](this, "bracketBox", void 0);
    _defineProperty__default["default"](this, "bracketDirection", void 0);
    _defineProperty__default["default"](this, "areas", void 0);
    _defineProperty__default["default"](this, "hover", void 0);
    _defineProperty__default["default"](this, "hovering", void 0);
    _defineProperty__default["default"](this, "selected", void 0);
    _defineProperty__default["default"](this, "selectionPlate", void 0);
    _defineProperty__default["default"](this, "atoms", void 0);
    _defineProperty__default["default"](this, "atomSet", void 0);
    _defineProperty__default["default"](this, "parentAtomSet", void 0);
    _defineProperty__default["default"](this, "patoms", void 0);
    _defineProperty__default["default"](this, "allAtoms", void 0);
    _defineProperty__default["default"](this, "bonds", void 0);
    _defineProperty__default["default"](this, "xBonds", void 0);
    _defineProperty__default["default"](this, "neiAtoms", void 0);
    _defineProperty__default["default"](this, "pp", void 0);
    _defineProperty__default["default"](this, "data", void 0);
    _defineProperty__default["default"](this, "dataArea", void 0);
    _defineProperty__default["default"](this, "functionalGroup", void 0);
    _defineProperty__default["default"](this, "attachmentPoints", void 0);
    this.type = type;
    this.id = -1;
    this.label = -1;
    this.bracketBox = null;
    this.bracketDirection = new vec2.Vec2(1, 0);
    this.areas = [];
    this.hover = false;
    this.hovering = null;
    this.selected = false;
    ...
    this.atoms = [];
    this.atomSet = new pile.Pile();
    this.parentAtomSet = new pile.Pile();
    this.patoms = [];
    this.allAtoms = false;
    this.bonds = [];
    this.xBonds = [];
  ...
  _createClass__default["default"](SGroup, [{
    ...
    value: function updateOffset(offset) {
      assert.assert(this.bracketBox, 'SGroup.updateOffset: bracketBox is required');
      this.pp = vec2.Vec2.sum(this.bracketBox.p1, offset);
    }
  }, {
    key: "isExpanded",
    ...
    value: function calculatePP(struct) {
      var topLeftPoint;
      var isAtomContext = this.data.context === constants.SgContexts.Atom;
      var isBondContent = this.data.context === constants.SgContexts.Bond;
      if (isAtomContext || isBondContent) {
        var contentBoxes = [];
        this.atoms.forEach(function (aid) {
          var atom = struct.atoms.get(aid);
          assert.assert(atom, "SGroup.calculatePP: atom ".concat(aid, " is not found"));
          var pos = new vec2.Vec2(atom.pp);
          var ext = new vec2.Vec2(0.05 * 3, 0.05 * 3);
          var bba = new box2Abs.Box2Abs(pos, pos).extend(ext, ext);
        ...
        var contentBB = contentBoxes.reduce(function (contentBounds, bba) {
          ...
          [bba.p0.x, bba.p1.x].forEach(function (x) {
            [bba.p0.y, bba.p1.y].forEach(function (y) {
              var v = new vec2.Vec2(x, y);
              bbb = !bbb ? new box2Abs.Box2Abs(v, v) : bbb.include(v);
            });
          });
          assert.assert(bbb, 'SGroup.calculatePP: failed to build atom bounding box');
          return !contentBounds ? bbb : box2Abs.Box2Abs.union(contentBounds, bbb);
        }, null);
        assert.assert(contentBB, 'SGroup.calculatePP: content bounding box is required');
        topLeftPoint = isBondContent ? contentBB.centre() : contentBB.p0;
      } else {
        assert.assert(this.bracketBox, 'SGroup.calculatePP: bracketBox is required');
        topLeftPoint = this.bracketBox.p1.add(new vec2.Vec2(0.5, 0.5));
      }
      ...
      for (var _i = 0, _sgroups = sgroups; _i < _sgroups.length; _i++) {
        ...
        topLeftPoint = topLeftPoint.add(new vec2.Vec2(0, 0.5));
      }
    ...
    value: function getContractedPosition(struct) {
      ...
      var positions = geometry.getAtomPositions(this.atoms, struct.atoms);
      if (positions.length > 0) {
        return {
          atomId: atomId,
          position: geometry.geometricCenter(positions)
        };
      }
      var atom = struct.atoms.get(atomId);
      assert.assert(atom, "SGroup.getContractedPosition: atom ".concat(atomId, " is not found"));
      return {
        atomId: atomId,
        position: atom.pp
      };
    ...
    value: function getOffset(sgroup) {
      ...
      return vec2.Vec2.diff(sgroup.pp, sgroup.bracketBox.p1);
    }
  }, {
    key: "isSaltOrSolvent",
    value: function isSaltOrSolvent(moleculeName) {
      var saltsAndSolventsProvider$1 = saltsAndSolventsProvider.SaltsAndSolventsProvider.getInstance();
      var saltsAndSolvents = saltsAndSolventsProvider$1.getSaltsAndSolventsList();
    ...
    value: function clone(sgroup, aidMap) {
      ...
      cp.atoms = sgroup.atoms.map(function (elem) {
        ...
        assert.assert(remappedAtomId !== undefined, "SGroup.clone: missing remapped atom id for ".concat(elem));
    ...
    value: function bracketPos(sGroup, mol, remol, render) {
      ...
      var PADDING_VECTOR = !SGroup.isCOPGroup(sGroup) ? new vec2.Vec2(0.2, 0.4) : new vec2.Vec2(1.2, 1.2);
      ...
      sGroup.bracketDirection = new vec2.Vec2(1, 0);
      atoms.forEach(function (aid) {
        ...
        if ('getVBoxObj' in atom && atom.getVBoxObj && render) {
          ...
          var position = new vec2.Vec2(atom.pp);
          structBoundingBox = new box2Abs.Box2Abs(position, position);
        }
      ...
      contentBoxes.forEach(function (bba) {
        braketBox = !braketBox ? bba : box2Abs.Box2Abs.union(braketBox, bba);
      });
      ...
      assert.assert(currentRender, 'SGroup.bracketPos: render instance is required');
      ...
      braketBox = attachmentPointsVBox && braketBox ? box2Abs.Box2Abs.union(braketBox, attachmentPointsVBox) : braketBox;
    ...
    value: function getBracketParameters(mol, crossBondsPerAtom, atomSet, bb, d, n) {
      ...
      if (crossBonds.length < 2) {
        (function () {
          d = d || new vec2.Vec2(1, 0);
          n = n || d.rotateSC(1, 0);
          var bracketWidth = Math.min(0.25, bb.sz().x * 0.3);
          var cl = vec2.Vec2.lc2(d, bb.p0.x, n, 0.5 * (bb.p0.y + bb.p1.y));
          var cr = vec2.Vec2.lc2(d, bb.p1.x, n, 0.5 * (bb.p0.y + bb.p1.y));
        ...
        (function () {
          ...
          assert.assert(b1, "SGroup.getBracketParameters: first cross-bond ".concat(crossBonds[0], " is not found"));
          assert.assert(b2, "SGroup.getBracketParameters: second cross-bond ".concat(crossBonds[1], " is not found"));
          var cl0 = b1.getCenter(mol);
          var cr0 = b2.getCenter(mol);
          var dr = vec2.Vec2.diff(cr0, cl0).normalized();
          var dl = dr.negated();
        ...
        (function () {
          ...
          try {
            for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
              ...
              assert.assert(b, "SGroup.getBracketParameters: cross-bond ".concat(crossBondId, " is not found"));
    ...
    value: function getObjBBox(atoms, mol) {
      ...
      assert.assert(a0, "SGroup.getObjBBox: atom ".concat(atoms[0], " position is not found"));
      var bb = new box2Abs.Box2Abs(a0, a0);
      ...
      try {
        for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
          ...
          assert.assert(atom, "SGroup.getObjBBox: atom ".concat(aid, " is not found"));
          var sgroupId = atom.sgs.values().next().value;
          var sgroup = _.isNumber(sgroupId) ? mol.sgroups.get(sgroupId) : undefined;
    ...
    value: function prepareMulForSaving(sgroup, mol) {
      ...
      sgroup.atomSet = new pile.Pile(sgroup.atoms);
      sgroup.parentAtomSet = new pile.Pile(sgroup.atomSet);
      var inBonds = [];
      var xBonds = [];
      mol.bonds.forEach(function (bond, bid) {
      ...
      if (xBonds.length === 2) {
        ...
        assert.assert(bond1, "SGroup.prepareMulForSaving: first cross-bond ".concat(xBonds[0], " is not found"));
        xAtom1 = sgroup.parentAtomSet.has(bond1.begin) ? bond1.begin : bond1.end;
        var bond2 = mol.bonds.get(xBonds[1]);
        assert.assert(bond2, "SGroup.prepareMulForSaving: second cross-bond ".concat(xBonds[1], " is not found"));
      ...
      var _loop = function _loop() {
        ...
        sgroup.atoms.forEach(function (aid) {
          var atom = mol.atoms.get(aid);
          assert.assert(atom, "SGroup.prepareMulForSaving: atom ".concat(aid, " is not found"));
        ...
        inBonds.forEach(function (bid) {
          ...
          assert.assert(bond, "SGroup.prepareMulForSaving: bond ".concat(bid, " is not found"));
      ...
      if (tailAtom >= 0) {
        ...
        assert.assert(xBond2, "SGroup.prepareMulForSaving: cross-bond ".concat(xBonds[1], " is not found"));
    ...
    value: function getMassCentre(mol, atoms) {
      ...
      try {
        for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
          ...
          assert.assert(atom, "SGroup.getMassCentre: atom ".concat(atomId, " is not found"));
...
function descriptorIntersects(sgroups, topLeftPoint) {
  return sgroups.some(function (sg) {
    ...
    var sgBottomRightPoint = sg.pp.add(new vec2.Vec2(0.5, 0.5));
    var bottomRightPoint = topLeftPoint.add(new vec2.Vec2(0.5, 0.5));
    return box2Abs.Box2Abs.segmentIntersection(sg.pp, sgBottomRightPoint, topLeftPoint, bottomRightPoint);
  });
}
