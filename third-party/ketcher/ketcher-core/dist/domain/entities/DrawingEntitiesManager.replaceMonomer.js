...
function replaceMonomer(drawingEntitiesManager, monomer, newMonomerItem) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      assert.assert(polymerBondInfo.bond);
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      assert.assert(monomerToAtomBondInfo.bond);
...
exports.replaceMonomer = replaceMonomer;
//# sourceMappingURL=DrawingEntitiesManager.replaceMonomer.js.map
