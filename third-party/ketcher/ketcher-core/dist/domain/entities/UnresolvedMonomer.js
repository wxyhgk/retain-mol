...
var UnresolvedMonomer = function (_BaseMonomer) {
  _inherits__default["default"](UnresolvedMonomer, _BaseMonomer);
  function UnresolvedMonomer() {
    _classCallCheck__default["default"](this, UnresolvedMonomer);
    return _callSuper(this, UnresolvedMonomer, arguments);
  }
  _createClass__default["default"](UnresolvedMonomer, [{
    key: "getValidSourcePoint",
    value: function getValidSourcePoint(secondMonomer) {
      if (!secondMonomer) {
        return this.firstFreeAttachmentPoint;
      }
      return Peptide.Peptide.prototype.getValidSourcePoint.call(this, secondMonomer);
    }
  }, {
    ...
    value: function getValidTargetPoint(firstMonomer) {
      ...
      return Peptide.Peptide.prototype.getValidTargetPoint.call(this, firstMonomer);
    }
  }, {
    ...
    value: function isMonomerTypeDifferentForChaining(monomerToChain) {
      return ![PeptideSubChain.PeptideSubChain, ChemSubChain.ChemSubChain].includes(monomerToChain.SubChainConstructor);
    }
  }]);
  return UnresolvedMonomer;
}(BaseMonomer.BaseMonomer);

exports.UnresolvedMonomer = UnresolvedMonomer;
//# sourceMappingURL=UnresolvedMonomer.js.map
