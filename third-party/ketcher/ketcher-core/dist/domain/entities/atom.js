...
var atomList = require('./atomList.js');
...
var Atom = function (_BaseMicromoleculeEnt) {
  ...
  function Atom(attributes) {
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "fragment", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "atomList", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "attachmentPoints", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "isotope", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "isPreview", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "hCount", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "radical", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "cip", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "charge", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "explicitValence", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "ringBondCount", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "queryProperties", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "unsaturatedAtom", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "substitutionCount", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "valence", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "implicitH", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "implicitHCount", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "pp", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "neighbors", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "sgs", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "badConn", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "alias", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "rglabel", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "aam", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "invRet", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "exactChangeFlag", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "rxnFragmentType", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "stereoLabel", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "stereoParity", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "hasImplicitH", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "pseudo", void 0);
    ...
    _this.pp = attributes.pp ? new vec2.Vec2(attributes.pp) : new vec2.Vec2();
    _this.sgs = new pile.Pile();
    ...
    _this.atomList = attributes.atomList ? new atomList.AtomList(attributes.atomList) : null;
    _this.neighbors = [];
    _this.badConn = false;
  ...
  _createClass__default["default"](Atom, [{
    ...
    value: function isPseudo() {
      return !this.atomList && !this.rglabel && !elements.Elements.get(this.label);
    }
  }, {
    key: "hasRxnProps",
    ...
    value: function getAttachmentAtomExternalConnections(struct, attachmentAtomId, leavingGroupAtomid) {
      ...
      var atomId = _.isNumber(attachmentAtomId) ? attachmentAtomId : leavingGroupAtomid;
      var atom = struct.atoms.get(atomId);
      var attachmentPoint = _.isNumber(attachmentAtomId) ? Atom.getSuperAtomAttachmentPointByAttachmentAtom(struct, atomId, searchBySgroups) : Atom.getSuperAtomAttachmentPointByLeavingGroup(struct, atomId, searchBySgroups);
    ...
    value: function isHiddenLeavingGroupAtom(struct, atomId) {
      ...
      var atom = struct.atoms.get(atomId);
      if (atom && !includeAtomsInCollapsedSgroups && functionalGroup.FunctionalGroup.isAtomInContractedFunctionalGroup(atom, struct.sgroups, struct.functionalGroups)) {
        return false;
      }
    ...
    value: function isSGroup(structOrSgroup) {
      return structOrSgroup instanceof sgroup.SGroup;
    }
  }]);
  return Atom;
...
function isCorrectPseudo(label) {
  return !elements.Elements.get(label) && label !== 'L' && label !== 'L#' && label !== 'R#';
}
