...
function buildFragments(atoms, connectivity) {
  ...
  connectivity.forEach(function (_ref) {
    var _ref$atomIndices = _slicedToArray(_ref.atomIndices, 2),
...
function createCalculationSnapshotV1(struct) {
  ...
  var atoms = sourceAtomIds.map(function (sourceAtomId, index) {
    ...
    return {
      ...
      element: atom.label,
      atomicNumber: (_Elements$get$number = (_Elements$get = Elements.get(atom.label)) === null || _Elements$get === void 0 ? void 0 : _Elements$get.number) !== null && _Elements$get$number !== void 0 ? _Elements$get$number : null,
...
export { CALCULATION_SNAPSHOT_SCHEMA_VERSION, createCalculationSnapshotV1 };
//# sourceMappingURL=calculationSnapshot.modern.js.map
