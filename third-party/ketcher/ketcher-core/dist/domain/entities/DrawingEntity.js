...
var DrawingEntity = function () {
  function DrawingEntity() {
    var _this$config;
    var _position = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new vec2.Vec2(0, 0);
    var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {
      generateId: true
    };
    _classCallCheck__default["default"](this, DrawingEntity);
    _defineProperty__default["default"](this, "_position", void 0);
    ...
    _defineProperty__default["default"](this, "baseRenderer", void 0);
    this._position = _position;
    this.config = config;
    this._position = _position || new vec2.Vec2(0, 0);
  ...
  _createClass__default["default"](DrawingEntity, [{
    ...
    value: function selectIfLocatedInRectangle(rectangleTopLeftPoint, rectangleBottomRightPoint) {
      ...
      assert.assert(this.baseRenderer);
      var prevSelectedValue = this.selected;
      var selectionPoints = this.baseRenderer.selectionPoints || [coordinates.Coordinates.modelToCanvas(this.center)];
    ...
    value: function isPointInPolygon(r, p) {
      var d = new vec2.Vec2(0, 1);
      var n = d.rotate(Math.PI / 2);
      var v0 = vec2.Vec2.diff(r[r.length - 1], p);
      var n0 = vec2.Vec2.dot(n, v0);
      var d0 = vec2.Vec2.dot(d, v0);
      var w0 = new vec2.Vec2(0, 0);
      var counter = 0;
      var eps = 1e-5;
      var flag1 = false;
      var flag0 = false;
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var v1 = vec2.Vec2.diff(point, p);
          var w1 = vec2.Vec2.diff(v1, v0);
          var n1 = vec2.Vec2.dot(n, v1);
          var d1 = vec2.Vec2.dot(d, v1);
          flag1 = false;
          if (n1 * n0 < 0) {
            if (d1 * d0 > -eps) {
          ...
          if (flag1 && flag0 && vec2.Vec2.dot(w1, n) * vec2.Vec2.dot(w0, n) >= 0) {
            flag1 = false;
          }
          if (flag1) {
            counter++;
...
//# sourceMappingURL=DrawingEntity.js.map
