...
import { canvasToMonomerCoordinates, getSearchFunction, findLabelPoint } from './helpers/attachmentPointCalculations.modern.js';
...
import { isBondBetweenSugarAndBaseOfRna } from './helpers/monomers.modern.js';
...
var AttachmentPoint = function () {
  function AttachmentPoint(constructorParams, skipInit) {
    ...
    _defineProperty(this, "attachmentPoint", void 0);
    _defineProperty(this, "monomer", void 0);
    _defineProperty(this, "bodyWidth", void 0);
    _defineProperty(this, "bodyHeight", void 0);
    _defineProperty(this, "attachmentPointName", void 0);
    _defineProperty(this, "canvasOffset", void 0);
    _defineProperty(this, "centerOfMonomer", void 0);
    _defineProperty(this, "element", void 0);
    _defineProperty(this, "hoverableArea", void 0);
    _defineProperty(this, "initialAngle", 0);
    _defineProperty(this, "isUsed", void 0);
    _defineProperty(this, "isDragTarget", void 0);
    _defineProperty(this, "isDragCircleHover", void 0);
    _defineProperty(this, "isSnake", void 0);
    _defineProperty(this, "applyZoomForPositionCalculation", void 0);
    ...
    this.centerOfMonomer = (_constructorParams$mo = (_constructorParams$mo2 = constructorParams.monomer.renderer) === null || _constructorParams$mo2 === void 0 ? void 0 : _constructorParams$mo2.center) !== null && _constructorParams$mo !== void 0 ? _constructorParams$mo : new Vec2(0, 0, 0);
  ...
  _createClass(AttachmentPoint, [{
    ...
    value: function renderHoverableArea(monomerCenter, attachmentPointCenter, angleDegrees, hasBond) {
      ...
      var lineFunction = line().x(function (_ref) {
        var x = _ref.x;
        return x;
      }).y(function (_ref2) {
        var y = _ref2.y;
    ...
    value: function appendAttachmentPoint() {
      ...
      var firstMonomer = polymerBond instanceof MonomerToAtomBond ? polymerBond.monomer : polymerBond === null || polymerBond === void 0 ? void 0 : polymerBond.firstMonomer;
      var flip = this.monomer.id === (firstMonomer === null || firstMonomer === void 0 ? void 0 : firstMonomer.id);
      var isAttachmentpointR1 = this.attachmentPointName === AttachmentPointName.R1;
      var isAttachmentpointR2 = this.attachmentPointName === AttachmentPointName.R2;
      if (!polymerBond) {
        angleDegrees = this.initialAngle;
      } else if (!(polymerBond instanceof MonomerToAtomBond) && !isBondBetweenSugarAndBaseOfRna(polymerBond) && (this.isSnake && !polymerBond.isHorizontal || editor.mode.modeName === 'snake-layout-mode' && polymerBond.isSideChainConnection)) {
      ...
      var _this$getCoordinates = this.getCoordinates(angleDegrees),
        _this$getCoordinates2 = _slicedToArray(_this$getCoordinates, 3),
    ...
    value: function getCoordinates(angleDegrees) {
      var _this$catchThePoint = this.catchThePoint(angleDegrees),
        _this$catchThePoint2 = _slicedToArray(_this$catchThePoint, 3),
    ...
    value: function updateCoords() {
      ...
      var _this$getCoordinates3 = this.getCoordinates(angleDegrees),
        _this$getCoordinates4 = _slicedToArray(_this$getCoordinates3, 3),
    ...
    value: function catchThePoint(rotationAngle) {
      ...
      var _findLabelPoint = findLabelPoint(pointOnBorder, this.initialAngle - 180, AttachmentPoint.attachmentPointLength, AttachmentPoint.labelOffset, AttachmentPoint.labelSize, this.isUsed),
        _findLabelPoint2 = _slicedToArray(_findLabelPoint, 2),
...
_defineProperty(AttachmentPoint, "attachmentPointVector", 6);
_defineProperty(AttachmentPoint, "attachmentPointLength", Math.hypot(_AttachmentPoint.attachmentPointVector, _AttachmentPoint.attachmentPointVector));
_defineProperty(AttachmentPoint, "labelOffset", 3.5);
_defineProperty(AttachmentPoint, "radius", 3);
_defineProperty(AttachmentPoint, "dragTargetRadius", 5);
_defineProperty(AttachmentPoint, "labelSize", {
  x: 3.5,
  y: 2.5
});
_defineProperty(AttachmentPoint, "DRAG_TARGET_INDICATOR_FONT_SIZE", '5px');
_defineProperty(AttachmentPoint, "colors", {
  fillUsed: '#0097A8',
  fill: 'white',
...
export { AttachmentPoint };
//# sourceMappingURL=AttachmentPoint.modern.js.map
