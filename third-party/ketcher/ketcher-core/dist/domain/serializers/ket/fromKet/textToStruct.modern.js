 ...
 ***************************************************************************/
import { Text } from '../../../entities/text.modern.js';
import { getNodeWithInvertedYCoord } from '../helpers.modern.js';
import { convertDraftToLexical } from '../../../../application/render/restruct/draftToLexical.modern.js';
    ...
    if ((_node = node) !== null && _node !== void 0 && _node.content) {
      try {
        ...
        if (parsed && Array.isArray(parsed.blocks)) {
          var lexical = convertDraftToLexical(parsed);
...
export { textToStruct };
//# sourceMappingURL=textToStruct.modern.js.map
