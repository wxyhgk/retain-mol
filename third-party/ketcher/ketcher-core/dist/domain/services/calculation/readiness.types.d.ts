...
export type CalculationReadinessIssueCode = 'EMPTY_STRUCTURE' | 'MISSING_COORDINATES' | 'NON_FINITE_COORDINATES' | 'GEOMETRY_APPEARS_TWO_DIMENSIONAL' | 'UNKNOWN_ATOMIC_NUMBER' | 'ATOMIC_NUMBER_MISMATCH' | 'TOTAL_CHARGE_INFERRED' | 'INVALID_TOTAL_CHARGE' | 'MULTIPLICITY_UNSPECIFIED' | 'INVALID_MULTIPLICITY' | 'ELECTRON_MULTIPLICITY_MISMATCH' | 'INVALID_ELECTRON_COUNT' | 'MULTIPLE_FRAGMENTS' | 'IMPLICIT_HYDROGENS_PRESENT';
