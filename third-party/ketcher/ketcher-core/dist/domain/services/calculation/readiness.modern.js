...
function atomicNumberFromElement(element) {
  ...
  return (_Elements$get$number = (_Elements$get = Elements.get(element)) === null || _Elements$get === void 0 ? void 0 : _Elements$get.number) !== null && _Elements$get$number !== void 0 ? _Elements$get$number : null;
}
...
function validateCalculationReadiness(snapshot) {
  ...
  atoms.forEach(function (atom) {
    ...
    if (!Number.isInteger(suppliedAtomicNumber) || suppliedAtomicNumber <= 0 || Elements.get(suppliedAtomicNumber) === undefined) {
      unknownAtomicNumberAtoms.push(atom);
      return;
    }
...
export { validateCalculationReadiness };
//# sourceMappingURL=readiness.modern.js.map
