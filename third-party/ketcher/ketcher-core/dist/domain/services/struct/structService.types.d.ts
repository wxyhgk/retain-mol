...
export declare enum ChemicalMimeType {
    ...
    XYZ = "chemical/x-xyz",
    ExtendedXYZ = "chemical/x-extxyz",
    QCSchema = "application/qcschema+json",
...
export type CheckTypes = 'radicals' | 'pseudoatoms' | 'stereo' | 'query' | 'overlapping_atoms' | 'overlapping_bonds' | 'rgroups' | 'chiral' | '3d' | 'chiral_flag' | 'valence';
...
export type CalculateProps = 'molecular-weight' | 'most-abundant-mass' | 'monoisotopic-mass' | 'gross' | 'mass-composition';
