...
var isPolymerBondLike = function isPolymerBondLike(bond) {
  return Boolean(bond && _typeof__default["default"](bond) === 'object' && 'getAnotherMonomer' in bond && !(bond instanceof MonomerToAtomBond.MonomerToAtomBond));
};
...
var isBondBetweenSugarAndBaseOfRna = function isBondBetweenSugarAndBaseOfRna(polymerBond) {
  return polymerBond.firstMonomerAttachmentPoint === monomers.AttachmentPointName.R1 && isRnaBaseOrAmbiguousRnaBase(polymerBond.firstMonomer) && polymerBond.secondMonomerAttachmentPoint === monomers.AttachmentPointName.R3 && isSugarMonomer(polymerBond.secondMonomer) || polymerBond.firstMonomerAttachmentPoint === monomers.AttachmentPointName.R3 && isSugarMonomer(polymerBond.firstMonomer) && polymerBond.secondMonomerAttachmentPoint === monomers.AttachmentPointName.R1 && isRnaBaseOrAmbiguousRnaBase(polymerBond.secondMonomer);
};
...
//# sourceMappingURL=polymerBondMonomerConnections.js.map
