...
var attachmentPointCalculations = require('./attachmentPointCalculations.js');
...
function getAttachmentPointStereoBond(sGroup, sGroupAttachmentPoint) {
  ...
  var attachmentPointLabel = attachmentPointCalculations.getAttachmentPointLabel(attachmentPointNumber);
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var bond$1 = monomerStruct.bonds.get(bondId);
      if (!bond$1) {
        continue;
      }
      var isSuitableStereoBond = bond$1.stereo === bond.Bond.PATTERN.STEREO.UP || bond$1.stereo === bond.Bond.PATTERN.STEREO.DOWN;
      if (!isSuitableStereoBond) {
        continue;
      }
      if (bond$1.begin === monomerAttachmentAtomId) {
        return bond$1.stereo;
      }
    }
  } catch (err) {
    _iterator.e(err);
...
exports.getAttachmentPointStereoBond = getAttachmentPointStereoBond;
//# sourceMappingURL=getAttachmentPointStereoBond.js.map
