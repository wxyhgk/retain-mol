...
function findLabelPoint(pointOnBorder, angle, lineLength, lineOffset, labelSize, isUsed) {
  var angleRadians = vec2.Vec2.degrees_to_radians(angle);
  var pointOfAttachment = vec2.Vec2.findSecondPoint(pointOnBorder, lineLength, angleRadians);
...
function getSearchFunction(initialAngle, canvasOffset, monomer) {
  return function findPointOnMonomerBorder(coordStart, length, applyZoomForPositionCalculation) {
    ...
    var angleRadians = vec2.Vec2.degrees_to_radians(angle);
    var secondPoint = vec2.Vec2.findSecondPoint(coordStart, length, angleRadians);
    var diff = vec2.Vec2.diff(new vec2.Vec2(coordStart.x, coordStart.y), new vec2.Vec2(secondPoint.x, secondPoint.y));
    if (diff.length() < 1.01) {
      return secondPoint;
    }
    ...
    var zoomedCoordinateOfSecondPoint = applyZoomForPositionCalculation ? coordinates.Coordinates.canvasToView(new vec2.Vec2(secondPoint)) : new vec2.Vec2(secondPoint);
    var newPointCoord = {
...
exports.attachmentPointNumberToAngle = void 0;
...
})(exports.attachmentPointNumberToAngle || (exports.attachmentPointNumberToAngle = {}));
...
exports.anglesToSector = anglesToSector;
exports.canvasToMonomerCoordinates = canvasToMonomerCoordinates;
exports.checkFor0and360 = checkFor0and360;
exports.findLabelPoint = findLabelPoint;
exports.getAttachmentPointLabel = getAttachmentPointLabel;
exports.getAttachmentPointLabelWithBinaryShift = getAttachmentPointLabelWithBinaryShift;
exports.getAttachmentPointNumberFromLabel = getAttachmentPointNumberFromLabel;
exports.getNextFreeAttachmentPoint = getNextFreeAttachmentPoint;
exports.getSearchFunction = getSearchFunction;
exports.isSingleRGroupAttachmentPoint = isSingleRGroupAttachmentPoint;
exports.sectorsList = sectorsList;
//# sourceMappingURL=attachmentPointCalculations.js.map
