...
import { MOLECULE_EDIT_PLAN_SCHEMA } from './moleculeEditPlan.types.modern.js';
...
function createMoleculeEditPlanFromStruct(structure) {
  ...
  while (visitedAtoms.size < atoms.length) {
    ...
    while (queue.length) {
      ...
      var neighbors = _toConsumableArray((_adjacency$get5 = adjacency.get(current)) !== null && _adjacency$get5 !== void 0 ? _adjacency$get5 : []).sort(function (first, second) {
...
export { createMoleculeEditPlanFromStruct };
//# sourceMappingURL=moleculeEditPlan.modern.js.map
