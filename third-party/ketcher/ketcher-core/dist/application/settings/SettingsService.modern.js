...
import { SettingsValidationError } from './types.modern.js';
import { getDefaultSettings, PRESETS } from './schema.modern.js';
import { LocalStorageAdapter } from './LocalStorageAdapter.modern.js';
import { SchemaValidator } from './SchemaValidator.modern.js';
import { SettingsMigration } from './SettingsMigration.modern.js';
...
var SettingsService = function () {
  function SettingsService() {
    ...
    _defineProperty(this, "autoSave", void 0);
  ...
  _createClass(SettingsService, [{
        ...
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              if (stored) {
                migrated = SettingsMigration.migrate(stored);
                merged = this.mergeWithDefaults(migrated);
                validation = this.validator.validate(merged);
                if (!validation.valid) {
                  KetcherLogger.warn('Invalid settings in storage, using defaults', validation.errors);
                } else {
            ...
            case 13:
              ...
              KetcherLogger.error('[SettingsService] Failed to initialize settings:', _context.t0);
              this.initialized = true;
            case 17:
            case "end":
    ...
    key: "updateSettings",
    value: (function () {
      var _updateSettings = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(partial) {
        ...
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 15:
              ...
              KetcherLogger.error('[SettingsService] Failed to persist settings:', _context2.t0);
            case 18:
    ...
    key: "resetToDefaults",
    value: (function () {
      var _resetToDefaults = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3() {
        var defaults;
    ...
    key: "loadPreset",
    value: (function () {
      var _loadPreset = _asyncToGenerator(_regeneratorRuntime.mark(function _callee4(name) {
        var preset;
    ...
    key: "importSettings",
    value: (function () {
      var _importSettings = _asyncToGenerator(_regeneratorRuntime.mark(function _callee5(json) {
        var parsed;
    ...
    value: (
    function () {
      var _getInstance = _asyncToGenerator(_regeneratorRuntime.mark(function _callee6() {
        var options,
          _args6 = arguments;
...
_defineProperty(SettingsService, "instance", null);

export { SettingsService };
//# sourceMappingURL=SettingsService.modern.js.map
