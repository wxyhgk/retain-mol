...
var monomerSizeState = require('./monomerSizeState.js');
...
var BaseMonomerRenderer = function (_BaseRenderer) {
  ...
  function BaseMonomerRenderer(monomer, monomerHoveredElementId, monomerSymbolElementId, monomerAutochainPreviewElementId, scale) {
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "monomerHoveredElementId", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "monomerSymbolElementId", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "monomerAutochainPreviewElementId", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "scale", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "editor", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "selectionCircle", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "selectionBorder", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "freeSectorsList", attachmentPointCalculations.sectorsList);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "attachmentPoints", []);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "hoveredAttachmentPoint", null);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "_dragTargetAttachmentPoint", null);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "_dragCircleHoverAttachmentPoint", null);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "monomerSymbolElement", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "monomerSize", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "enumerationElement", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "enumeration", null);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "terminalIndicatorElement", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "CHAIN_START_TERMINAL_INDICATOR_TEXT", '');
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "CHAIN_END_TERMINAL_INDICATOR_TEXT", '');
    ...
    _this.editor = editorSingleton.provideEditorInstance();
    ...
    monomerSizeState.setMonomerSize(_this.monomerSize);
    return _this;
  }
  _createClass__default["default"](BaseMonomerRenderer, [{
    ...
    key: "center",
    get: function get() {
      return new vec2.Vec2(this.scaledMonomerPosition.x + this.monomerSize.width / 2, this.scaledMonomerPosition.y + this.monomerSize.height / 2);
    }
  }, {
    key: "getHighlightPath",
    value: function getHighlightPath() {
      var offset = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      return monomerHighlightShapes.createRectHighlightPath(this.center, this.monomerSize.width, this.monomerSize.height, offset);
    }
  }, {
    key: "textColor",
    get: function get() {
      ...
      if (!hasDragTarget) {
        this.monomer.usedAttachmentPointsNamesList.forEach(function (item) {
          ...
          var newList = _this2.freeSectorsList.filter(function (item) {
            return attachmentPointCalculations.anglesToSector[item].min > angle || attachmentPointCalculations.anglesToSector[item].max <= angle;
          });
          _this2.freeSectorsList = attachmentPointCalculations.checkFor0and360(newList);
        });
      }
      var unrenderedAtPoints = [];
      this.monomer.unUsedAttachmentPointsNamesList.forEach(function (item) {
        var properAngleForFreeAttachmentPoint = attachmentPointCalculations.attachmentPointNumberToAngle[item];
    ...
    value: function prepareAttachmentPointsParams(attachmentPointName, customAngle) {
      ...
      if (!this.monomer.isAttachmentPointUsed(attachmentPointName)) {
        rotation = attachmentPointCalculations.attachmentPointNumberToAngle[attachmentPointName];
      }
      return {
    ...
    value: function appendAttachmentPoint(attachmentPointName, customAngle) {
      ...
      return new AttachmentPoint.AttachmentPoint(attachmentPointParams);
    }
  }, {
    ...
    value: function removeAttachmentPoints() {
      ...
      this.freeSectorsList = attachmentPointCalculations.sectorsList;
    }
  }, {
    ...
    value: function appendRootElement(canvas) {
      ...
      if (this.monomer instanceof AmbiguousMonomer.AmbiguousMonomer) {
        monomerTypeAttribute = AmbiguousMonomer.AmbiguousMonomer.getMonomerClass(this.monomer.monomers);
    ...
    value: function appendLabel(rootElement) {
      ...
      var _monomerEntityFactory = monomerEntityFactory.monomerEntityFactory(this.monomer instanceof AmbiguousMonomer.AmbiguousMonomer ? this.monomer.variantMonomerItem : this.monomer.monomerItem),
    ...
    value: function appendSelection() {
      if (this.selectionCircle) {
        ...
        var _this$canvas;
        this.selectionCircle = (_this$canvas = this.canvas) === null || _this$canvas === void 0 ? void 0 : _this$canvas.insert('circle', ':first-child').attr('r', "".concat(BaseMonomerRenderer.selectionCircleRadius, "px")).attr('opacity', '0.7').attr('cx', this.center.x).attr('cy', this.center.y).attr('fill', constants.SELECTION_COLOR).attr('class', 'dynamic-element');
      }
    }
  }, {
    key: "removeSelection",
    ...
    value: function appendEvents() {
      ...
      this.bodyElement.on('mouseover', function (event) {
        ...
        if (((_event$relatedTarget = event.relatedTarget) === null || _event$relatedTarget === void 0 ? void 0 : _event$relatedTarget.__data__) instanceof AttachmentPoint.AttachmentPoint) {
          return;
        }
    ...
    value: function appendEnumeration() {
      ...
      assert.assert(this.enumerationElementPosition);
    ...
    key: "monomerSize",
    get: function get() {
      return monomerSizeState.getMonomerSize();
    }
  }, {
    ...
    value: function getScaledMonomerPosition(positionInAngstoms) {
      ...
      var monomerPositionInPixels = coordinates.Coordinates.modelToCanvas(positionInAngstoms);
      return new vec2.Vec2(monomerPositionInPixels.x - monomerSize.width / 2, monomerPositionInPixels.y - monomerSize.height / 2);
    }
  }]);
...
exports.MONOMER_CSS_CLASS = MONOMER_CSS_CLASS;
//# sourceMappingURL=BaseMonomerRenderer.js.map
