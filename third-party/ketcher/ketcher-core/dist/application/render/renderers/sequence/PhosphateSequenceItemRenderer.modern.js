...
var PhosphateSequenceItemRenderer = function (_BaseSequenceItemRend) {
  _inherits(PhosphateSequenceItemRenderer, _BaseSequenceItemRend);
  function PhosphateSequenceItemRenderer() {
    _classCallCheck(this, PhosphateSequenceItemRenderer);
    return _callSuper(this, PhosphateSequenceItemRenderer, arguments);
  }
  _createClass(PhosphateSequenceItemRenderer, [{
    key: "symbolToDisplay",
    get: function get() {
      return 'p';
    }
    ...
    value: function appendRootElement() {
      ...
      this.rootElement = _get(_getPrototypeOf(PhosphateSequenceItemRenderer.prototype), "appendRootElement", this).call(this);
...
export { PhosphateSequenceItemRenderer };
//# sourceMappingURL=PhosphateSequenceItemRenderer.modern.js.map
