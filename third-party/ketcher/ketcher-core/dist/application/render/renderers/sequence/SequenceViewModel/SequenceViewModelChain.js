...
var SequenceViewModelChain = function () {
  function SequenceViewModelChain() {
    _classCallCheck__default["default"](this, SequenceViewModelChain);
    _defineProperty__default["default"](this, "rows", []);
  }
  _createClass__default["default"](SequenceViewModelChain, [{
    key: "lastRow",
    get: function get() {
    ...
    get: function get() {
      return this.rows.some(function (row) {
        return row.sequenceViewModelItems.some(function (node) {
          return node.antisenseNode && !(node.antisenseNode instanceof EmptySequenceNode.EmptySequenceNode);
        });
      });
    }
  }, {
    ...
    get: function get() {
      return this.length === 1 && this.firstNode.senseNode instanceof EmptySequenceNode.EmptySequenceNode;
    }
  }, {
    key: "addRow",
...
exports.SequenceViewModelChain = SequenceViewModelChain;
//# sourceMappingURL=SequenceViewModelChain.js.map
