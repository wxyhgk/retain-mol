...
var NucleotideSequenceItemRenderer = function (_RNASequenceItemRende) {
  _inherits__default["default"](NucleotideSequenceItemRenderer, _RNASequenceItemRende);
  function NucleotideSequenceItemRenderer() {
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "phosphateModificationCircleElement", void 0);
    return _this;
  }
  _createClass__default["default"](NucleotideSequenceItemRenderer, [{
    ...
    value: function appendRootElement() {
      ...
      this.rootElement = _get__default["default"](_getPrototypeOf__default["default"](NucleotideSequenceItemRenderer.prototype), "appendRootElement", this).call(this);
      (_this$rootElement2 = this.rootElement) === null || _this$rootElement2 === void 0 || _this$rootElement2.attr('data-symbol-type', this.node.sugar.label === monomers.RNA_DNA_NON_MODIFIED_PART.SUGAR_DNA ? 'DNA' : 'RNA');
...
exports.NucleotideSequenceItemRenderer = NucleotideSequenceItemRenderer;
//# sourceMappingURL=NucleotideSequenceItemRenderer.js.map
