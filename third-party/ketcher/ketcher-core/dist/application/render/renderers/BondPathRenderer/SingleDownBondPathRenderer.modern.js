...
var SingleDownBondPathRenderer = function () {
  function SingleDownBondPathRenderer() {
    _classCallCheck(this, SingleDownBondPathRenderer);
  }
  _createClass(SingleDownBondPathRenderer, null, [{
    key: "preparePaths",
    value: function preparePaths(bondVectors) {
      ...
      var offsetBetweenLines = 1.2 * BondWidth;
      var numberOfLines = Math.max(Math.floor((bondLength - BondWidth) / (BondWidth + offsetBetweenLines)), 0) + 2;
...
export { SingleDownBondPathRenderer as default };
//# sourceMappingURL=SingleDownBondPathRenderer.modern.js.map
