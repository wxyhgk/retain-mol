...
var CHEM_HOVERED_ELEMENT_ID = constants.MONOMER_SYMBOLS_IDS[monomers.KetMonomerClass.CHEM].hover;
var CHEM_SYMBOL_ELEMENT_ID = constants.MONOMER_SYMBOLS_IDS[monomers.KetMonomerClass.CHEM].body;
var CHEM_AUTOCHAIN_PREVIEW_ELEMENT_ID = constants.MONOMER_SYMBOLS_IDS[monomers.KetMonomerClass.CHEM].autochainPreview;
var ChemRenderer = function (_BaseMonomerRenderer) {
  ...
  _createClass__default["default"](ChemRenderer, [{
    ...
    value: function show(theme) {
      if (this.monomer.monomerItem.props.isMicromoleculeFragment && !monomers$1.isMonomerSgroupWithAttachmentPoints(this.monomer)) {
        return;
      }
      _get__default["default"](_getPrototypeOf__default["default"](ChemRenderer.prototype), "show", this).call(this, theme);
    }
  }, {
...
//# sourceMappingURL=ChemRenderer.js.map
