...
import type { MonomerEntityClass, ConcreteMonomerEntityClass } from '../../../domain/helpers/monomerEntityFactory';
 ...
 */
export declare function monomerFactory(monomer: MonomerItemType): [
    EntityClass: ConcreteMonomerEntityClass,
    RendererClass: DerivedRendererClass,
    ketMonomerClass: KetMonomerClass
];
export declare function monomerFactory(monomer: MonomerOrAmbiguousType): [
