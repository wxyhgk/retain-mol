...
import { AtomRadical } from '../../../domain/entities/CoreAtom.modern.js';
...
import { AtomLabel } from '../../../domain/constants/element.types.modern.js';
import '../../../domain/constants/generics.modern.js';
import '../../../domain/constants/chains.modern.js';
import '../../../domain/constants/monomers.modern.js';
import { VALENCE_MAP } from '../restruct/constants.modern.js';
import { Box2Abs } from '../../../domain/entities/box2Abs.modern.js';
import { Vec2 } from '../../../domain/entities/vec2.modern.js';
import { StereoLabel } from '../../../domain/entities/atom.modern.js';
import { StereoLabelStyleType } from '../restruct/generalEnumTypes.modern.js';
...
import { SELECTION_HOVERED_COLOR, SELECTION_COLOR, BAD_VALENCE_LINE_OFFSET, BAD_VALENCE_WARNING_COLOR } from './constants.modern.js';
import '../../../domain/helpers/functionalGroupsProvider.modern.js';
import '../../../domain/helpers/saltsAndSolventsProvider.modern.js';
import { isGenericAtom } from '../../../domain/helpers/isGenericAtom.modern.js';
...
var AtomRenderer = function (_BaseRenderer) {
  _inherits(AtomRenderer, _BaseRenderer);
  function AtomRenderer(atom) {
    var _this;
    _classCallCheck(this, AtomRenderer);
    _this = _callSuper(this, AtomRenderer, [atom]);
    _defineProperty(_assertThisInitialized(_this), "atom", void 0);
    ...
    _defineProperty(_assertThisInitialized(_this), "radicalElement", void 0);
    _defineProperty(_assertThisInitialized(_this), "cipLabelElement", void 0);
    _defineProperty(_assertThisInitialized(_this), "stereoLabelElement", void 0);
    _defineProperty(_assertThisInitialized(_this), "badValenceElement", void 0);
    _defineProperty(_assertThisInitialized(_this), "cipLabelElementBBox", void 0);
    _defineProperty(_assertThisInitialized(_this), "cipTextElementBBox", void 0);
    _defineProperty(_assertThisInitialized(_this), "stereoLabelElementBBox", void 0);
    _defineProperty(_assertThisInitialized(_this), "stereoTextElementBBox", void 0);
    _this.atom = atom;
    atom.setRenderer(_assertThisInitialized(_this));
    return _this;
  }
  _createClass(AtomRenderer, [{
    key: "scaledPosition",
    get: function get() {
    ...
    value: function redrawHover() {
      if (this.drawingEntity.hovered) {
        ...
        if (this.atom.selected) {
          ...
          (_this$selectionElemen = this.selectionElement) === null || _this$selectionElemen === void 0 || _this$selectionElemen.attr('fill', SELECTION_HOVERED_COLOR);
        }
        this.showHover();
      } else {
        this.hideHover();
        if (this.atom.selected) {
          ...
          (_this$selectionElemen2 = this.selectionElement) === null || _this$selectionElemen2 === void 0 || _this$selectionElemen2.attr('fill', SELECTION_COLOR);
        }
      }
    }
  }, {
    ...
    get: function get() {
      var viewModel = provideEditorInstance().viewModel;
      ...
      if (!(atomHaldEdges !== null && atomHaldEdges !== void 0 && atomHaldEdges.length)) {
        if (this.atom.label === AtomLabel.D || this.atom.label === AtomLabel.T) {
          ...
          var element = Elements.get(this.atom.label);
    ...
    get: function get() {
      ...
      var viewModel = editor.viewModel;
      var atomNeighborsHalfEdges = viewModel.atomsToHalfEdges.get(this.atom);
      var isCarbon = this.atom.label === AtomLabel.C;
      ...
      if (isCarbon && !isAtomTerminal && !hasCharge && !hasRadical && !hasAlias && !hasExplicitValence && !hasExplicitIsotope) {
        if ((atomNeighborsHalfEdges === null || atomNeighborsHalfEdges === void 0 ? void 0 : atomNeighborsHalfEdges.length) === 2) {
          var _atomNeighborsHalfEdg2 = _slicedToArray(atomNeighborsHalfEdges, 2),
    ...
    value: function appendSelection() {
      ...
      if (!this.selectionElement) {
        var selectionContourElement = this.appendSelectionContour();
        this.selectionElement = selectionContourElement === null || selectionContourElement === void 0 ? void 0 : selectionContourElement.attr('fill', SELECTION_COLOR)
        .attr('class', 'dynamic-element');
      }
      (_this$cipLabelElement2 = this.cipLabelElement) === null || _this$cipLabelElement2 === void 0 || (_this$cipLabelElement2 = _this$cipLabelElement2.select('rect')) === null || _this$cipLabelElement2 === void 0 || _this$cipLabelElement2.attr('fill', SELECTION_COLOR);
    }
  }, {
    key: "removeSelection",
    ...
    value: function appendExplicitValence() {
      if (this.atom.hasExplicitValence) {
        ...
        (_this$textElement5 = this.textElement) === null || _this$textElement5 === void 0 || _this$textElement5.append('tspan').text("(".concat(VALENCE_MAP[explicitValence], ")")).attr('fill', this.labelColor).attr('letter-spacing', 0.2).attr('dy', -4);
      }
    }
  }, {
    ...
    value: function appendBadValenceWarning() {
      ...
      var lineY = labelBbox.height / 2 + BAD_VALENCE_LINE_OFFSET;
      var lineStartX = labelBbox.x;
      var lineEndX = labelBbox.x + labelBbox.width;
      this.badValenceElement = (_this$rootElement6 = this.rootElement) === null || _this$rootElement6 === void 0 ? void 0 : _this$rootElement6.append('line').attr('x1', lineStartX).attr('y1', lineY).attr('x2', lineEndX).attr('y2', lineY).attr('stroke', BAD_VALENCE_WARNING_COLOR).attr('stroke-width', 1).attr('pointer-events', 'none');
    }
  }, {
    key: "show",
    value: function show() {
    ...
    value: function positionCIPLabel() {
      ...
      var cipPosition = this.scaledPosition.add(new Vec2(shiftVector.x - (this.cipLabelElementBBox.x + this.cipLabelElementBBox.width / 2), shiftVector.y - (this.cipLabelElementBBox.y + this.cipLabelElementBBox.height / 2)));
    ...
    value: function bisectLargestSector() {
      var _provideEditorInstanc = provideEditorInstance().viewModel.getLargestSectorFromAtomNeighbours(this.atom),
    ...
    value: function positionStereoLabel() {
      ...
      var shiftVector = direction.scaled(projectedDistance);
      var stereoPosition = this.scaledPosition.add(new Vec2(shiftVector.x - (this.stereoLabelElementBBox.x + this.stereoLabelElementBBox.width / 2), shiftVector.y - (this.stereoLabelElementBBox.y + this.stereoLabelElementBBox.height / 2)));
    ...
    value: function getProjectedLabelDistance(width, height, direction) {
      ...
      this.labelBBoxes.forEach(function (labelSymbolBBox) {
        var absoluteBox = new Box2Abs(labelSymbolBBox.x, labelSymbolBBox.y, labelSymbolBBox.x + labelSymbolBBox.width, labelSymbolBBox.y + labelSymbolBBox.height).translate(_this3.scaledPosition);
        forwardShift = Math.max(forwardShift, util.shiftRayBox(_this3.scaledPosition, direction, absoluteBox));
      });
      var stereoLabelBox = {
      ...
      var backwardShift = util.shiftRayBox(this.scaledPosition, direction.negated(), Box2Abs.fromRelBox(stereoLabelBox));
    ...
    value: function remove() {
      ...
      this.hoverElement = undefined;
      _get(_getPrototypeOf(AtomRenderer.prototype), "remove", this).call(this);
    }
  }, {
    key: "setVisibility",
    value: function setVisibility(isVisible) {
      ...
      _get(_getPrototypeOf(AtomRenderer.prototype), "setVisibility", this).call(this, isVisible);
...
export { AtomRenderer };
//# sourceMappingURL=AtomRenderer.modern.js.map
