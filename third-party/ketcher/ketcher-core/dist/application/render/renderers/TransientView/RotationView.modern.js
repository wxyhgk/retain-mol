...
var RotationView = function (_TransientView) {
  ...
  _createClass(RotationView, null, [{
    ...
    value: function show(transientLayer, params) {
      ...
      var cursorInCanvas = isRotating && cursor ? Coordinates.viewToCanvas(cursor) : undefined;
      ...
      if (isRotating) {
        var centerInView = Coordinates.canvasToView(center);
...
_defineProperty(RotationView, "lastSnappingRadius", void 0);
_defineProperty(RotationView, "wasRotating", false);
_defineProperty(RotationView, "rotationHandleSubscribers", new Set());
_defineProperty(RotationView, "rotationCenterSubscribers", new Set());
_defineProperty(RotationView, "viewName", 'RotationView');

export { RotationView };
//# sourceMappingURL=RotationView.modern.js.map
