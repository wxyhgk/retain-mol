...
import ReAtom from './reatom.modern.js';
import ReBond from './rebond.modern.js';
import ReDataSGroupData from './redatasgroupdata.modern.js';
import ReEnhancedFlag from './reenhancedFlag.modern.js';
import ReFrag from './refrag.modern.js';
import ReLoop from './reloop.modern.js';
import ReRGroup from './rergroup.modern.js';
import ReRxnArrow from './rerxnarrow.modern.js';
import ReRxnPlus from './rerxnplus.modern.js';
import ReSGroup from './resgroup.modern.js';
import ReSimpleObject from './resimpleObject.modern.js';
import ReText from './retext.modern.js';
import util from '../util.modern.js';
import { ReRGroupAttachmentPoint } from './rergroupAttachmentPoint.modern.js';
import { ReImage } from './reImage.modern.js';
...
import { ReMultitailArrow } from './remultitailArrow.modern.js';
...
var ReStruct = function () {
  function ReStruct(molecule, render) {
    ...
    _defineProperty(this, "visibleAtoms", new Map());
    _defineProperty(this, "visibleBonds", new Map());
    ...
    _defineProperty(this, "rgroupAttachmentPoints", new Pool());
    ...
    _defineProperty(this, "needRecalculateVisibleAtomsAndBonds", false);
    ...
    _defineProperty(this, "imagesChanged", new Map());
    _defineProperty(this, "multitailArrowsChanged", new Map());
    _defineProperty(this, "snappingBonds", []);
    _defineProperty(this, "highlightOutlinePaths", []);
    this.render = render;
    ...
    molecule.images.forEach(function (item, id) {
      _this.images.set(id, new ReImage(item));
    });
    molecule.multitailArrows.forEach(function (item, id) {
      _this.multitailArrows.set(id, new ReMultitailArrow(item));
    });
  }
  _createClass(ReStruct, [{
    ...
    get: function get() {
      ...
      return this.rgroupAttachmentPoints.filter(function (_id, reItem) {
        ...
        assert(atom != null);
        return !FunctionalGroup.isAtomInContractedFunctionalGroup(atom, sgroups, functionalGroups);
      });
    }
  }, {
    ...
    value: function addReObjectPath(group, visel, path) {
      ...
      paths.forEach(function (path) {
        ...
        path.insertBefore(_this7.layers[LayerMap[group]]);
      });
    }
  }, {
    ...
    value: function recalculateVisibleAtomsAndBonds() {
      ...
      this.atoms.forEach(function (atom, aid) {
        ...
        if ((!FunctionalGroup.isAtomInContractedFunctionalGroup(atom.a, _this11.molecule.sgroups, _this11.molecule.functionalGroups) || ((_this11$molecule$getG = _this11.molecule.getGroupFromAtomId(aid)) === null || _this11$molecule$getG === void 0 ? void 0 : _this11$molecule$getG.getContractedPosition(_this11.molecule).atomId) === aid) && !Atom.isHiddenLeavingGroupAtom(_this11.molecule, aid)) {
          _this11.visibleAtoms.set(aid, atom);
        }
      });
      this.bonds.forEach(function (bond, bid) {
        if (!FunctionalGroup.isBondInContractedFunctionalGroup(bond.b, _this11.molecule.sgroups, _this11.molecule.functionalGroups) && !SGroup.isBondInContractedSGroup(bond.b, _this11.molecule.sgroups) && !Bond.isBondToHiddenLeavingGroup(_this11.molecule, bond.b)) {
          _this11.visibleBonds.set(bid, bond);
        }
      });
    }
  }, {
    ...
    value: function updateLoops() {
      ...
      ret.newLoops.forEach(function (loopId) {
        ...
        _this14.reloops.set(loopId, new ReLoop(loop));
      });
    }
  }, {
    key: "showLoops",
    ...
    value: function showFragments() {
      ...
      this.frags.forEach(function (frag) {
        ...
        if (path) {
          _this20.addReObjectPath(LayerMap.data, frag.visel, path, null, true);
        }
      });
    }
  }, {
    ...
    value: function setSelection(selection) {
      ...
      Object.keys(ReStruct.maps).forEach(function (map) {
        var _this31$map$values = _this31[map].values(),
          _this31$map$values2 = _slicedToArray(_this31$map$values, 1),
        ...
        if (ReStruct.maps[map].isSelectable() || mapValues instanceof ReSGroup) {
          _this31[map].forEach(function (item, id) {
            ...
            if (item instanceof ReSGroup && FunctionalGroup.isContractedFunctionalGroup(item === null || item === void 0 || (_item$item = item.item) === null || _item$item === void 0 ? void 0 : _item$item.id, _this31.molecule.functionalGroups)) {
...
_defineProperty(ReStruct, "maps", _defineProperty(_defineProperty({
  atoms: ReAtom,
  bonds: ReBond,
  rxnPluses: ReRxnPlus,
  ...
  texts: ReText
}, IMAGE_KEY, ReImage), MULTITAIL_ARROW_KEY, ReMultitailArrow));
...
export { ReStruct as default };
//# sourceMappingURL=restruct.modern.js.map
