...
var ScrollOffset = function () {
  ...
  _createClass__default["default"](ScrollOffset, [{
    ...
    value: function getAbsViewBox() {
      ...
      var viewBoxMinXY = new vec2.Vec2(viewBox.minX, viewBox.minY);
      var viewBoxMaxXY = new vec2.Vec2(viewBox.minX + viewBox.width, viewBox.minY + viewBox.height);
      return new box2Abs.Box2Abs(viewBoxMinXY, viewBoxMaxXY);
    }
  }, {
    ...
    value: function getAbsBoundingBox() {
      ...
      var boundingBoxMinXY = scale.Scale.modelToCanvas(protoBoundingBox.p0, _classPrivateFieldGet__default["default"](this, _render).options);
      var boundingBoxMaxXY = scale.Scale.modelToCanvas(protoBoundingBox.p1, _classPrivateFieldGet__default["default"](this, _render).options);
      return new box2Abs.Box2Abs(boundingBoxMinXY, boundingBoxMaxXY);
    }
  }, {
    key: "update",
