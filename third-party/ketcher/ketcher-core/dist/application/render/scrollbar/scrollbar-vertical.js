...
var VerticalScrollbar = function (_Scrollbar) {
  ...
  _createClass__default["default"](VerticalScrollbar, [{
    ...
    value: function hasOffset() {
      return _classPrivateFieldGet__default["default"](this, _scrollOffset).hasVerticalOffset();
    }
  }, {
    key: "getDynamicAttr",
    value: function getDynamicAttr() {
      var minX = this.render.viewBox.minX + this.render.viewBox.width - utils.getZoomedValue(this.DIST_TO_EDGE, this.render.options);
      var minY = this.render.viewBox.minY + _.clamp(utils.getUserFriendlyScrollOffset(_classPrivateFieldGet__default["default"](this, _scrollOffset).up), utils.getZoomedValue(this.MARGIN, this.render.options), this.render.viewBox.height - utils.getZoomedValue(this.MIN_LENGTH + this.MARGIN, this.render.options));
      var maxY = this.render.viewBox.minY + this.render.viewBox.height - _.clamp(utils.getUserFriendlyScrollOffset(_classPrivateFieldGet__default["default"](this, _scrollOffset).down), utils.getZoomedValue(this.MARGIN, this.render.options), this.render.viewBox.height);
      var length = Math.max(maxY - minY, utils.getZoomedValue(this.MIN_LENGTH, this.render.options));
      return {
        x: minX,
        y: minY,
        width: utils.getZoomedValue(this.WIDTH, this.render.options),
        height: length,
    ...
    value: function onDragMove(_dx, dy, _x, _y, _event) {
      ...
      this.render.setViewBox(_objectSpread(_objectSpread({}, this.viewBoxBeforeDrag), {}, {
        minY: this.viewBoxBeforeDrag.minY + utils.getUserFriendlyViewBoxDelta(dy)
      }));
    }
  }]);
...
//# sourceMappingURL=scrollbar-vertical.js.map
