...
var SnakeMode = function (_BaseMode) {
  ...
  _createClass__default["default"](SnakeMode, [{
    ...
    value: function initialize(_needRemoveSelection) {
      ...
      var modelChanges = _isUndo ? new Command.Command() : editor.drawingEntitiesManager.applySnakeLayout(true);
    ...
    value: function getNewNodePosition() {
      var editor = editorSingleton.provideEditorInstance();
      return coordinates.Coordinates.modelToCanvas(editor.drawingEntitiesManager.bottomRightMonomerPosition);
    }
  }, {
    key: "scrollForView",
    value: function () {
      var _scrollForView = _asyncToGenerator__default["default"](_regeneratorRuntime__default["default"].mark(function _callee() {
        var zoom, drawnEntitiesBoundingBox;
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              zoom = Zoom.ZoomTool.instance;
              drawnEntitiesBoundingBox = utils.getRenderedStructuresBbox();
              if (zoom.isFitToCanvasHeight(drawnEntitiesBoundingBox.height)) {
                zoom.scrollTo(new vec2.Vec2(drawnEntitiesBoundingBox.left, drawnEntitiesBoundingBox.top), false, 2);
              } else {
                zoom.scrollTo(new vec2.Vec2(drawnEntitiesBoundingBox.left, drawnEntitiesBoundingBox.bottom), true, 2);
              }
            case 3:
            case "end":
...
modesRegistry.registerMode('snake-layout-mode', SnakeMode);

exports.SnakeMode = SnakeMode;
//# sourceMappingURL=SnakeMode.js.map
