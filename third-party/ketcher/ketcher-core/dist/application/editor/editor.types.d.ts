...
import type { MonomerCreationState, Render, RenderOptions } from '../render';
...
export type EditorSelection = Partial<Record<typeof selectionKeys[number], number[]>> & {
...
export type EditorOptions = Partial<RenderOptions & {
...
export type EditorDocumentChangeReason = 'edit' | 'undo' | 'redo' | 'replace' | 'untracked' | 'mode' | 'dispose';
