import type { MonomerItemType, Entities, MonomerOrAmbiguousType } from '../../../domain/types';
import type { IKetMonomerGroupTemplate, IKetTemplateConnection, IKetIdtAliases } from '../../formatters/types/ket';
...
export interface IRnaLabeledPreset extends Omit<IRnaPreset, 'base' | 'sugar' | 'phosphate' | 'connections'>, Pick<IKetMonomerGroupTemplate, 'templates' | 'connections'> {
    connections?: IKetTemplateConnection[];
}
...
export type ToolConstructorInterface = new (editor: CoreEditor, ...args: unknown[]) => Tool | BaseTool;
