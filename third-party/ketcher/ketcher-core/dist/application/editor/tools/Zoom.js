...
var notifyRenderComplete = require('../../render/notifyRenderComplete.js');
...
exports.SCROLL_POSITION = void 0;
(function (SCROLL_POSITION) {
  SCROLL_POSITION["CENTER"] = "CENTER";
  SCROLL_POSITION["BOTTOM"] = "BOTTOM";
})(exports.SCROLL_POSITION || (exports.SCROLL_POSITION = {}));
...
var ZoomTool = function () {
  function ZoomTool(drawingEntitiesManager, canvas) {
    ...
    _defineProperty__default["default"](this, "zoom", void 0);
    _defineProperty__default["default"](this, "zoomLevel", void 0);
    _defineProperty__default["default"](this, "_zoomTransform", void 0);
    ...
    _defineProperty__default["default"](this, "scrollBars", void 0);
    ...
    if (canvas) {
      this.canvasWrapper = d3.select(canvas);
      this.canvas = d3.select(canvas).select(constants.drawnStructuresSelector);
    } else {
      this.canvasWrapper = d3.select(constants.canvasSelector);
      this.canvas = d3.select(constants.drawnStructuresSelector);
    }
    this.zoomLevel = 1;
    this._zoomTransform = new d3.ZoomTransform(1, 0, 0);
  ...
  _createClass__default["default"](ZoomTool, [{
    ...
    value: function scrollTo(position) {
      ...
      var xOffsetValue;
      if (_.isNumber(xOffset) && !isOffsetInPercents) {
        xOffsetValue = xOffset;
      } else {
        var xOffsetOrDefault = _.isNumber(xOffset) ? xOffset : AUTO_SCROLL_OFFSET_X;
        xOffsetValue = canvasWrapperWidth * xOffsetOrDefault / 100;
      }
      var yOffsetValue;
      if (_.isNumber(yOffset) && !isOffsetInPercents) {
        yOffsetValue = yOffset;
      } else {
        var yOffsetOrDefault = _.isNumber(yOffset) ? yOffset : AUTO_SCROLL_OFFSET_Y;
        yOffsetValue = canvasWrapperHeight * yOffsetOrDefault / 100;
      }
      var offset = new vec2.Vec2(canvasWrapperWidth / 2 - xOffsetValue, canvasWrapperHeight / 2 - yOffsetValue);
    ...
    value: function zoomToLeftTopCorner(_newZoomLevel) {
      ...
      (_this$zoom9 = this.zoom) === null || _this$zoom9 === void 0 || _this$zoom9.transform(this.canvasWrapper, new d3.ZoomTransform(newZoomLevel, newX, newY));
    }
  }, {
    key: "zoomTo",
    ...
    value: function resetZoom() {
      ...
      (_this$zoom0 = this.zoom) === null || _this$zoom0 === void 0 || _this$zoom0.transform(this.canvasWrapper, new d3.ZoomTransform(1, 0, 0));
    }
  }, {
    ...
    value: function scaleCoordinates(position) {
      ...
      return new vec2.Vec2(newX, newY);
    }
  }, {
    key: "invertZoom",
    ...
    value: function zoomStructureToFitHalfOfCanvas(structureBbox) {
      ...
      if (structureBbox.width < canvasWrapperSize.width / 2) {
        ...
        this.scrollTo(new vec2.Vec2(structureBbox.left, structureBbox.top), false, OFFSET_FROM_CANVAS_BORDER, OFFSET_FROM_CANVAS_BORDER);
      }
    }
  }, {
...
_defineProperty__default["default"](ZoomTool, "_instance", void 0);
_defineProperty__default["default"](ZoomTool, "_renderingContext", void 0);
