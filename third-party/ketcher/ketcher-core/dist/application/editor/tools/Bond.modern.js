...
import { MACROMOLECULES_BOND_TYPES, ToolName } from './types.modern.js';
...
import { shouldInvokeConnectionModal } from './bondConnectionHelpers.modern.js';
...
var PolymerBond = function () {
  function PolymerBond(editor) {
    ...
    _defineProperty(this, "bondRenderer", void 0);
    _defineProperty(this, "isBondConnectionModalOpen", false);
    _defineProperty(this, "history", void 0);
    _defineProperty(this, "bondType", void 0);
    _defineProperty(this, "handleBondCreation", function (payload) {
      assert(_this.bondRenderer);
    ...
    _defineProperty(this, "handleBondCreationCancellation", function (secondMonomer) {
    ...
    this.bondType = options.toolName === ToolName.bondSingle ? MACROMOLECULES_BOND_TYPES.SINGLE : MACROMOLECULES_BOND_TYPES.HYDROGEN;
  }
  _createClass(PolymerBond, [{
    ...
    value: function mouseDownAttachmentPoint(event) {
      ...
      if (selectedRenderer instanceof AttachmentPoint && !selectedRenderer.monomer.isAttachmentPointUsed(event.attachmentPointName)) {
    ...
    value: function mousedown(event) {
      ...
      if (selectedRenderer instanceof BaseMonomerRenderer || selectedRenderer instanceof AttachmentPoint) {
        ...
        var _this$editor$drawingE = this.editor.drawingEntitiesManager.startPolymerBondCreation(selectedRenderer.monomer, selectedRenderer.monomer.position, Coordinates.canvasToModel(this.editor.lastCursorPositionOfCanvas), this.bondType),
    ...
    value: function mouseLeaveMonomer(event) {
      ...
      if (eventToElementData instanceof AttachmentPoint && eventToElementData.monomer === (eventFromElementData === null || eventFromElementData === void 0 ? void 0 : eventFromElementData.monomer)) {
    ...
    value: function mouseUpAttachmentPoint(event) {
      ...
      if (this.bondRenderer && !isFirstMonomerHovered) {
        ...
        for (var attachmentPoint in secondMonomer.attachmentPointsToBonds) {
          ...
          if (alreadyHasBond) {
            var existingBondIsSingleBond = !(bond instanceof HydrogenBond);
    ...
    value: function finishBondCreation(secondMonomer) {
      ...
      var firstMonomerAttachmentPoint = this.isHydrogenBond ? AttachmentPointName.HYDROGEN : this.bondRenderer.polymerBond.firstMonomer.getPotentialAttachmentPointByBond(this.bondRenderer.polymerBond);
      var secondMonomerAttachmentPoint = this.isHydrogenBond ? AttachmentPointName.HYDROGEN : secondMonomer.getPotentialAttachmentPointByBond(this.bondRenderer.polymerBond);
      ...
      return this.editor.drawingEntitiesManager.finishPolymerBondCreation(this.bondRenderer.polymerBond, secondMonomer, firstMonomerAttachmentPoint, this.isHydrogenBond ? AttachmentPointName.HYDROGEN : secondMonomerAttachmentPoint, this.bondType);
    }
  }, {
    key: "mouseup",
    ...
    value: function mouseUpAtom(event) {
      ...
      var existingBondWithMonomer = atom.bonds.find(function (bond) {
        return bond instanceof MonomerToAtomBond && bond.monomer === monomer;
      });
    ...
    value: function shouldInvokeModal(firstMonomer, secondMonomer) {
      ...
      return shouldInvokeConnectionModal(firstMonomer, secondMonomer, checkForPotentialBonds, this.isHydrogenBond);
    }
  }]);
  return PolymerBond;
}();
