...
var getMonomerTemplateId = function getMonomerTemplateId(monomer) {
  ...
  return isAmbiguousMonomer ? helpers.setAmbiguousMonomerTemplatePrefix(templateId) : helpers.setMonomerTemplatePrefix(templateId);
};
var isSugarPhosphateConnection = function isSugarPhosphateConnection(connection, sugarTemplateId, phosphateTemplateId) {
  ...
  return !endpointAttachmentPoints.includes(monomers.AttachmentPointName.R3) && endpointAttachmentPoints.includes(monomers.AttachmentPointName.R1) && endpointAttachmentPoints.includes(monomers.AttachmentPointName.R2);
};
var getRnaPresetPhosphatePosition = function getRnaPresetPhosphatePosition(preset) {
  ...
  return sugarEndpoint.attachmentPointId === monomers.AttachmentPointName.R1 ? 'left' : 'right';
};
  ...
  if (baseTemplateId && sugarTemplateId) {
    connections.push({
      ...
      endpoint1: {
        ...
        attachmentPointId: monomers.AttachmentPointName.R1
      },
      endpoint2: {
        templateId: sugarTemplateId,
        attachmentPointId: monomers.AttachmentPointName.R3
      }
    });
  }
  if (sugarTemplateId && phosphateTemplateId) {
    connections.push({
      ...
      endpoint1: {
        templateId: sugarTemplateId,
        attachmentPointId: phosphatePosition === 'left' ? monomers.AttachmentPointName.R1 : monomers.AttachmentPointName.R2
      },
      endpoint2: {
        templateId: phosphateTemplateId,
        attachmentPointId: phosphatePosition === 'left' ? monomers.AttachmentPointName.R2 : monomers.AttachmentPointName.R1
      }
    });
  }
  return connections;
...
exports.buildRnaPresetConnections = buildRnaPresetConnections;
exports.getRnaPresetPhosphatePosition = getRnaPresetPhosphatePosition;
//# sourceMappingURL=rnaPresetConnections.js.map
