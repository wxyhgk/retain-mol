...
var ActionTransaction = function () {
  function ActionTransaction(restruct) {
    _classCallCheck__default["default"](this, ActionTransaction);
    ...
    _classPrivateFieldSet__default["default"](this, _restruct, restruct);
  }
  _createClass__default["default"](ActionTransaction, [{
    key: "capture",
    value: function capture(inverse) {
      var _this = this;
      this.assertActive('capture');
      if (inverse instanceof action.Action) {
        var capturedAction = new action.Action(_toConsumableArray__default["default"](inverse.operations));
        _classPrivateFieldGet__default["default"](this, _steps).push({
          rollback: function rollback() {
            capturedAction.perform(_classPrivateFieldGet__default["default"](_this, _restruct));
          }
        });
        _classPrivateFieldGet__default["default"](this, _inverseAction).mergeWith(capturedAction);
      } else {
        _classPrivateFieldGet__default["default"](this, _steps).push({
          rollback: function rollback() {
            inverse.perform(_classPrivateFieldGet__default["default"](_this, _restruct));
          }
        });
        _classPrivateFieldGet__default["default"](this, _inverseAction).addOp(inverse);
      }
      return inverse;
    }
  }, {
    ...
    value: function commit() {
      if (_classPrivateFieldGet__default["default"](this, _state) === 'rolled-back') {
        throw new Error('Cannot commit a rolled-back action transaction');
      }
      _classPrivateFieldSet__default["default"](this, _state, 'committed');
      return _classPrivateFieldGet__default["default"](this, _inverseAction);
    }
  }, {
    key: "rollback",
    value: function rollback(cause) {
      var hasCause = arguments.length > 0;
      if (_classPrivateFieldGet__default["default"](this, _state) === 'committed') {
      ...
      _classPrivateFieldSet__default["default"](this, _state, 'rolled-back');
      var rollbackErrors = [];
      var _iterator = _createForOfIteratorHelper(_toConsumableArray__default["default"](_classPrivateFieldGet__default["default"](this, _steps)).reverse()),
        _step;
      try {
    ...
    value: function assertActive(operation) {
      if (_classPrivateFieldGet__default["default"](this, _state) !== 'active') {
...
function isPromiseLike(value) {
  return _typeof__default["default"](value) === 'object' && value !== null && 'then' in value && typeof value.then === 'function';
}
...
exports.ActionTransaction = ActionTransaction;
exports.runActionTransaction = runActionTransaction;
//# sourceMappingURL=actionTransaction.js.map
