...
var CalcImplicitH = function (_BaseOperation) {
  ...
  function CalcImplicitH(aids) {
    ...
    _this = _callSuper(this, CalcImplicitH, [OperationType.CALC_IMPLICIT_H, OperationPriority.CALC_IMPLICIT_H]);
    _defineProperty(_assertThisInitialized(_this), "atomIds", void 0);
    _this.atomIds = aids;
    return _this;
  }
...
export { CalcImplicitH };
//# sourceMappingURL=calcimplicitH.modern.js.map
