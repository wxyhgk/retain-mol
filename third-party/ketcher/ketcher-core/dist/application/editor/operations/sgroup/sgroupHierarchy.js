...
var SGroupAddToHierarchy = function (_BaseOperation) {
  ...
  function SGroupAddToHierarchy(sgroupId, parent, children) {
    ...
    _this = _callSuper(this, SGroupAddToHierarchy, [OperationType.OperationType.S_GROUP_ADD_TO_HIERACHY, OperationType.OperationPriority.S_GROUP_ADD_TO_HIERACHY]);
  ...
  _createClass__default["default"](SGroupAddToHierarchy, [{
    ...
    value: function execute(restruct) {
      ...
      if (!sgroup) {
        KetcherLogger.KetcherLogger.error("SGroupAddToHierarchy: S-Group ".concat(sgid, " not found"));
        return;
      }
...
var SGroupRemoveFromHierarchy = function (_BaseOperation2) {
  ...
  function SGroupRemoveFromHierarchy(sgroupId) {
    ...
    _this2 = _callSuper(this, SGroupRemoveFromHierarchy, [OperationType.OperationType.S_GROUP_REMOVE_FROM_HIERACHY, 110]);
...
//# sourceMappingURL=sgroupHierarchy.js.map
