...
var MultitailArrowAddOperation = function () {
  function MultitailArrowAddOperation(addArrowChangeModel, deleteArrowChangeModel) {
    _classCallCheck__default["default"](this, MultitailArrowAddOperation);
    ...
    _defineProperty__default["default"](this, "multitailArrow", void 0);
  ...
  _createClass__default["default"](MultitailArrowAddOperation, [{
    key: "execute",
...
var MultitailArrowDeleteOperation = function () {
  function MultitailArrowDeleteOperation(multitailArrow, deleteArrowChangeModel, addArrowChangeModel) {
    _classCallCheck__default["default"](this, MultitailArrowDeleteOperation);
    _defineProperty__default["default"](this, "multitailArrow", void 0);
    _defineProperty__default["default"](this, "deleteArrowChangeModel", void 0);
    _defineProperty__default["default"](this, "addArrowChangeModel", void 0);
    _defineProperty__default["default"](this, "priority", 2);
  ...
  _createClass__default["default"](MultitailArrowDeleteOperation, [{
    key: "execute",
    value: function execute(renderersManager) {
      this.deleteArrowChangeModel(this.multitailArrow);
      renderersManager.deleteMultitailArrow(this.multitailArrow);
...
exports.MultitailArrowAddOperation = MultitailArrowAddOperation;
exports.MultitailArrowDeleteOperation = MultitailArrowDeleteOperation;
