...
var AlignDescriptors = function (_BaseOperation) {
  ...
  function AlignDescriptors() {
    ...
    _this = _callSuper(this, AlignDescriptors, [OperationType.OperationType.ALIGN_DESCRIPTORS]);
  ...
  _createClass__default["default"](AlignDescriptors, [{
    ...
    value: function execute(restruct) {
      ...
      if (!structBox) return;
      var alignPoint = new vec2.Vec2(structBox.max.x, structBox.min.y).add(new vec2.Vec2(2.0, -1.0));
      sgroups.forEach(function (sgroup) {
        _this2.history[sgroup.id] = sgroup.pp ? new vec2.Vec2(sgroup.pp) : null;
        alignPoint = alignPoint.add(new vec2.Vec2(0.0, 0.5));
...
_defineProperty__default["default"](AlignDescriptors, "InverseConstructor", void 0);

exports.AlignDescriptors = AlignDescriptors;
//# sourceMappingURL=AlignDescriptors.js.map
