...
var RxnPlusMove = function (_BaseOperation) {
  ...
  function RxnPlusMove(id, d, noinvalidate) {
    ...
    _this = _callSuper(this, RxnPlusMove, [OperationType.OperationType.RXN_PLUS_MOVE]);
  ...
  _createClass__default["default"](RxnPlusMove, [{
    ...
    value: function execute(restruct) {
      ...
      if (!noinvalidate) {
        BaseOperation.BaseOperation.invalidateItem(restruct, 'rxnPluses', id, 1);
      }
    }
  }, {
    key: "invert",
...
//# sourceMappingURL=RxnPlusMove.js.map
