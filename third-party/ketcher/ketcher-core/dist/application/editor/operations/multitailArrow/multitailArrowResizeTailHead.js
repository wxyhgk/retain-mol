...
var MultitailArrowResizeTailHead = function (_BaseOperation) {
  _inherits__default["default"](MultitailArrowResizeTailHead, _BaseOperation);
  function MultitailArrowResizeTailHead(id, offset, isHead) {
    var _this;
    _classCallCheck__default["default"](this, MultitailArrowResizeTailHead);
    _this = _callSuper(this, MultitailArrowResizeTailHead, [OperationType.OperationType.MULTITAIL_ARROW_RESIZE_HEAD_TAIL]);
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "isHead", void 0);
    _this.id = id;
    _this.offset = offset;
    _this.isHead = isHead;
    return _this;
  }
  _createClass__default["default"](MultitailArrowResizeTailHead, [{
    key: "execute",
    value: function execute(reStruct) {
      ...
      this.offset = this.isHead ? multitailArrow$1.resizeHead(this.offset) : multitailArrow$1.resizeTails(this.offset);
...
exports.MultitailArrowResizeTailHead = MultitailArrowResizeTailHead;
//# sourceMappingURL=multitailArrowResizeTailHead.js.map
