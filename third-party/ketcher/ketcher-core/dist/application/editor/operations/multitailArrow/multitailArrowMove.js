...
var MultitailArrowMove = function (_BaseOperation) {
  _inherits__default["default"](MultitailArrowMove, _BaseOperation);
  function MultitailArrowMove(id, offset) {
    var _this;
    _classCallCheck__default["default"](this, MultitailArrowMove);
    _this = _callSuper(this, MultitailArrowMove, [OperationType.OperationType.MULTITAIL_ARROW_MOVE]);
  ...
  _createClass__default["default"](MultitailArrowMove, [{
    key: "execute",
    value: function execute(reStruct) {
      ...
      var scaledOffset = scale.Scale.modelToCanvas(this.offset, reStruct.render.options);
...
exports.MultitailArrowMove = MultitailArrowMove;
//# sourceMappingURL=multitailArrowMove.js.map
