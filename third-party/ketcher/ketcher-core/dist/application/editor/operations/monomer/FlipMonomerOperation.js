...
var FlipMonomerOperation = function (_BaseOperation) {
  _inherits__default["default"](FlipMonomerOperation, _BaseOperation);
  function FlipMonomerOperation(data) {
    var _this;
    _classCallCheck__default["default"](this, FlipMonomerOperation);
    _this = _callSuper(this, FlipMonomerOperation, [OperationType.OperationType.FLIP_MONOMER]);
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "previousRotate", void 0);
    _this.data = data;
    return _this;
  }
  _createClass__default["default"](FlipMonomerOperation, [{
    key: "execute",
...
exports.FlipMonomerOperation = FlipMonomerOperation;
//# sourceMappingURL=FlipMonomerOperation.js.map
