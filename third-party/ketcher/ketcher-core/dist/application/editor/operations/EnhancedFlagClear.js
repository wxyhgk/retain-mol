...
var EnhancedFlagClear = function (_BaseOperation) {
  _inherits__default["default"](EnhancedFlagClear, _BaseOperation);
  function EnhancedFlagClear(fragmentId) {
    var _this;
    _classCallCheck__default["default"](this, EnhancedFlagClear);
    _this = _callSuper(this, EnhancedFlagClear, [OperationType.OperationType.ENHANCED_FLAG_MOVE]);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "data", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "restorePosition", void 0);
    _this.data = {
      frid: fragmentId
    };
    return _this;
  }
  _createClass__default["default"](EnhancedFlagClear, [{
    key: "execute",
    value: function execute(restruct) {
      var frid = this.data.frid;
      var fragment = restruct.molecule.frags.get(frid);
      if (!fragment) return;
      this.data.previousPosition = fragment.stereoFlagPosition ? new vec2.Vec2(fragment.stereoFlagPosition.x, fragment.stereoFlagPosition.y) : undefined;
...
exports.EnhancedFlagClear = EnhancedFlagClear;
//# sourceMappingURL=EnhancedFlagClear.js.map
