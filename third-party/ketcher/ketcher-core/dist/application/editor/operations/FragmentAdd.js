...
var reenhancedFlag = require('../../render/restruct/reenhancedFlag.js');
var refrag = require('../../render/restruct/refrag.js');
...
var FragmentAdd = function (_BaseOperation) {
  ...
  function FragmentAdd(fragmentId, properties) {
    ...
    _this = _callSuper(this, FragmentAdd, [OperationType.OperationType.FRAGMENT_ADD]);
  ...
  _createClass__default["default"](FragmentAdd, [{
    ...
    value: function execute(restruct) {
      ...
      var frag = new fragment.Fragment([], null, this.properties);
      if (this.frid === null) {
        this.frid = struct.frags.add(frag);
      } else {
        struct.frags.set(this.frid, frag);
      }
      restruct.frags.set(this.frid, new refrag["default"](frag));
      restruct.markItem('frags', this.frid, 1);
      restruct.enhancedFlags.set(this.frid, new reenhancedFlag["default"]());
    }
  }, {
    key: "invert",
...
_defineProperty__default["default"](FragmentAdd, "InverseConstructor", void 0);

exports.FragmentAdd = FragmentAdd;
//# sourceMappingURL=FragmentAdd.js.map
