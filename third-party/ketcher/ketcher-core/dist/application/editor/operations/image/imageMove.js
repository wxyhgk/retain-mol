...
var ImageMove = function (_BaseOperation) {
  _inherits__default["default"](ImageMove, _BaseOperation);
  function ImageMove(id, offset) {
    var _this;
    _classCallCheck__default["default"](this, ImageMove);
    _this = _callSuper(this, ImageMove, [OperationType.OperationType.IMAGE_MOVE]);
  ...
  _createClass__default["default"](ImageMove, [{
    key: "execute",
...
exports.ImageMove = ImageMove;
//# sourceMappingURL=imageMove.js.map
