...
var SGroupAddOperation = function () {
  function SGroupAddOperation(addSGroupChangeModel, deleteSGroupChangeModel) {
    _classCallCheck__default["default"](this, SGroupAddOperation);
    _defineProperty__default["default"](this, "addSGroupChangeModel", void 0);
    _defineProperty__default["default"](this, "deleteSGroupChangeModel", void 0);
    _defineProperty__default["default"](this, "sgroupDrawingEntity", void 0);
  ...
  _createClass__default["default"](SGroupAddOperation, [{
    key: "execute",
...
var SGroupDeleteOperation = function () {
  function SGroupDeleteOperation(sgroupDrawingEntity, deleteSGroupChangeModel, addSGroupChangeModel) {
    _classCallCheck__default["default"](this, SGroupDeleteOperation);
    _defineProperty__default["default"](this, "sgroupDrawingEntity", void 0);
    _defineProperty__default["default"](this, "deleteSGroupChangeModel", void 0);
    _defineProperty__default["default"](this, "addSGroupChangeModel", void 0);
    _defineProperty__default["default"](this, "priority", 2);
  ...
  _createClass__default["default"](SGroupDeleteOperation, [{
    key: "execute",
    value: function execute(renderersManager) {
      this.deleteSGroupChangeModel(this.sgroupDrawingEntity);
      renderersManager.deleteSGroup(this.sgroupDrawingEntity);
...
exports.SGroupAddOperation = SGroupAddOperation;
exports.SGroupDeleteOperation = SGroupDeleteOperation;
