...
var BondAttr = function (_BaseOperation) {
  ...
  function BondAttr(bondId, attribute, value) {
    ...
    _this = _callSuper(this, BondAttr, [OperationType.OperationType.BOND_ATTR, OperationType.OperationPriority.BOND_ATTR]);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "data", void 0);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "data2", void 0);
    _this.data = {
      bid: bondId,
      attribute: attribute,
      value: value,
  ...
  _createClass__default["default"](BondAttr, [{
    ...
    value: function execute(restruct) {
      if (this.data) {
        ...
        if (attribute === 'type') {
          BaseOperation.BaseOperation.invalidateLoop(restruct, bid);
        }
      }
    }
  }, {
...
//# sourceMappingURL=BondAttr.js.map
