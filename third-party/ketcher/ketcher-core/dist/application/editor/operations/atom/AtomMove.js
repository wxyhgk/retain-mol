...
var AtomMove = function (_BaseOperation) {
  ...
  function AtomMove(atomId, d, noinvalidate) {
    ...
    _this = _callSuper(this, AtomMove, [OperationType.OperationType.ATOM_MOVE, OperationType.OperationPriority.ATOM_MOVE]);
  ...
  _createClass__default["default"](AtomMove, [{
    ...
    value: function execute(restruct) {
      ...
      if (!this.data.noinvalidate) {
        BaseOperation.BaseOperation.invalidateAtom(restruct, aid, 1);
      }
    }
  }, {
    key: "invert",
...
//# sourceMappingURL=AtomMove.js.map
