...
function provideEditorInstance(ketcherId) {
  ...
  var values = _toConsumableArray(editorInstances.values());
  return (_values = values[values.length - 1]) !== null && _values !== void 0 ? _values : _lastEditorInstance;
}

export { provideEditorInstance, resetEditorInstance, setEditorInstance, setEditorRenderingContext };
//# sourceMappingURL=editorSingleton.modern.js.map
