...
function isCalculationGeometryFormat(format) {
  return [SupportedFormat.mol2, SupportedFormat.xyz, SupportedFormat.extendedXYZ, SupportedFormat.qcSchema].includes(format);
}

export { SupportedFormat, isCalculationGeometryFormat };
//# sourceMappingURL=structFormatter.types.modern.js.map
