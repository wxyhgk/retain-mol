...
export declare function setComputationalFormatMetadata(struct: Struct, metadata: ComputationalFormatMetadata): void;
export declare function getComputationalFormatMetadata(struct: Struct): ComputationalFormatMetadata | undefined;
