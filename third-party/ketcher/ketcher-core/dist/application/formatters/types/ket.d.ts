...
export type AmbiguousMonomerTransformation = Pick<MonomerTransformation, 'flip'>;
...
export type IKetConnectionEndPoint = IKetConnectionMonomerEndPoint & IKetConnectionMoleculeEndPoint;
...
export type monomerClass = 'RNA' | 'PEPTIDE' | 'CHEM' | 'UNKNOWN' | 'DNA' | 'MODDNA';
...
export type IKetMacromoleculesContent = IKetMacromoleculesContentRootProperty & IKetMacromoleculesContentOtherProperties;
