...
import { getLabelRenderModeForIndigo } from '../helpers.modern.js';
...
function pickStandardServerOptions(ketcherId, options) {
  var ketcherInstance = ketcherProvider.getKetcher(ketcherId);
  return {
  ...
  _createClass(RemoteStructService, [{
    ...
    value: function layout(data, options) {
      var expandedOptions = _objectSpread(_objectSpread({}, this.getStandardServerOptions(options)), {}, {
        'render-label-mode': this.ketcherId ? getLabelRenderModeForIndigo(this.ketcherId) : undefined,
...
export { RemoteStructService, pickStandardServerOptions };
//# sourceMappingURL=remoteStructService.modern.js.map
