...
var normalizeShortcut = function normalizeShortcut(input) {
  ...
  return [].concat(_toConsumableArray__default["default"](appliedModifiersInOrder), [key]).join('+');
};
...
function keyNormBase(obj) {
  ...
  return _typeof__default["default"](obj) === 'object' ? normalizeKeyMap(obj) : normalizeShortcut(obj);
}
...
exports.CanonicalModifiersOrder = CanonicalModifiersOrder;
exports.KeyCodePrefixes = KeyCodePrefixes;
exports.KeyboardModifiers = KeyboardModifiers;
exports.ModifiersRegex = ModifiersRegex;
exports.initHotKeys = initHotKeys;
exports.isControlKey = isControlKey;
exports.keyNorm = keyNorm;
//# sourceMappingURL=keynorm.js.map
