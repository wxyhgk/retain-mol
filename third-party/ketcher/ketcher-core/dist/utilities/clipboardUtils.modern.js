...
var clipboardDataTypes = [ChemicalMimeType.KET, ChemicalMimeType.Mol, ChemicalMimeType.Rxn, PLAIN_TEXT_MIME_TYPE];
...
function legacyPaste(cb, formats) {
  var data = _defineProperty({}, PLAIN_TEXT_MIME_TYPE, '');
  if (!cb) {
    return data;
  }
...
function _getStructStringFromClipboardData() {
  _getStructStringFromClipboardData = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(data) {
...
function _isPasteContentAvailable() {
  _isPasteContentAvailable = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2() {
...
function _safelyGetMimeType() {
  _safelyGetMimeType = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3(clipboardItem, mimeType) {
    var result;
...
export { PLAIN_TEXT_MIME_TYPE, getStructStringFromClipboardData, isClipboardAPIAvailable, isPasteContentAvailable, legacyCopy, legacyPaste, notifyCopyCut, safelyGetMimeType };
//# sourceMappingURL=clipboardUtils.modern.js.map
