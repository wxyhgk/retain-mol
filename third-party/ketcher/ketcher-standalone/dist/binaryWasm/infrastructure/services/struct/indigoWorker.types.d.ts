...
export interface IndigoModule {
    ...
    calculate(struct: string, options: IndigoOptions, selectedAtoms: IndigoVectorInt): string;
    automap(struct: string, mode: string, format: string, options: IndigoOptions): string;
    aromatize(struct: string, format: string, options: IndigoOptions): string;
    clean2d(struct: string, format: string, options: IndigoOptions, selectedAtoms: IndigoVectorInt): string;
    convert(struct: string, format: string, options: IndigoOptions): string;
    version(): string;
    convert_explicit_hydrogens(struct: string, mode: string, format: string, options: IndigoOptions): string;
...
export type CalculateProps = 'molecular-weight' | 'most-abundant-mass' | 'monoisotopic-mass' | 'gross' | 'gross-formula' | 'mass-composition';
...
export type OutputMessage<T> = OutputMessageWithError | OutputMessageWithoutError<T>;
