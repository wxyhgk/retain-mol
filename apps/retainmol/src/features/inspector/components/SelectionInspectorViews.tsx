...
type AtomModel = Extract<InspectorModel, { mode: 'atom' }>
...
function EditableGeometryPanel({ geometry }: { geometry: EditableLiveGeometry }) {
  ...
  return (
      ...
      <div className="text-[10px] text-muted-foreground">{geometry.editHint}</div>
    </div></InspectorSection>
  )
}
