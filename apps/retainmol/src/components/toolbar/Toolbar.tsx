...
export default function Toolbar({ showInspector, onToggleInspector, onOpenTemplateStudio, onSearchOpen }: ToolbarProps) {
    ...
    <TooltipProvider delayDuration={300}>
      <header className="relative z-50 flex h-14 shrink-0 select-none items-center gap-2 border-b border-border bg-card px-3 text-card-foreground shadow-sm">
        ...
        <div className="hidden min-w-0 items-center gap-2 md:flex">
          <span className="max-w-40 truncate text-xs font-semibold text-foreground" title={molecule.name || 'New Molecule'}>
